...
Optional hybrid: tossctl works fully without the official API, and you can plug it in so officially-supported features route through it for extra stability.
