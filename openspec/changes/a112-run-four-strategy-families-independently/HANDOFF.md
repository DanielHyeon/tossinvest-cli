...
한 줄(2026-09-03 두 번째 갱신): 5 절에서 남은 것은 **5.1.2.2 · 5.2 · 5.3.3 · 5.6.2** 다.
그전 한 줄(같은 날): 5 절에서 남은 것은 5.1.2 · 5.2 · 5.3.3 · 5.6.2 였다.
...
| 이 커밋 | 5.1.2.1 랜딩 — 여덟 레인이 생산 런타임 안에 서고, 전략군의 사이클이 `*Context` 클로저가 아니게 됐다. 여덟은 여전히 DORMANT 이므로 **생산 동작 변화 0** |
...
**결정할 것:** 8 절(서명 매니페스트)을 5.1.2.2 보다 먼저 세울지, 아니면 5.2·5.3.3 을
먼저 하고 8 절과 5.1.2.2 를 한 로트로 묶을지. 후자를 고르면 여덟은 그때까지
...
3. 그다음 열려 있는 태스크로 간다. 5 절에서 남은 것은
   **5.1.2.2 · 5.2 · 5.3.3 · 5.6.2**, 그다음이 6 절이다.
