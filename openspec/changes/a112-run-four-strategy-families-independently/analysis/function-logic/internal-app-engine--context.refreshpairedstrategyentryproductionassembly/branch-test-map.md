...
|---|---|---|---|---|
| B1 | if at 448:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B2 | if at 454:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B3 | if at 458:2 | planned targeted RED before any edit; not run by L0 | no | no |
