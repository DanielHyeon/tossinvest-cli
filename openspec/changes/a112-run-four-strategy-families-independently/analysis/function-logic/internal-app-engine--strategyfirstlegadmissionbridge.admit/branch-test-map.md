...
|---|---|---|---|---|
| B1 | if at 71:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B2 | if at 74:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B3 | if at 78:2 | planned targeted RED before any edit; not run by L0 | no | no |
