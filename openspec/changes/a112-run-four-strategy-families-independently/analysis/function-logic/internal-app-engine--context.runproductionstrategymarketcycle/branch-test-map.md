...
|---|---|---|---|---|
| B1 | if at 421:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B2 | if at 425:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B3 | if at 430:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B4 | if at 433:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B5 | if at 437:2 | planned targeted RED before any edit; not run by L0 | no | no |
