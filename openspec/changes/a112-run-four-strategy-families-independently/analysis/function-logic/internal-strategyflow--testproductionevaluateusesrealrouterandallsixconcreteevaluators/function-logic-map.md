...
| `provenance.Version` | 82:37 |
| `provenance.Digest` | 82:67 |
| `provenance.AsOf` | 82:96 |
| `provenance.Currency` | 82:123 |
| `provenance.MinorScale` | 82:160 |
| `provenance.UnitVersion` | 82:196 |
| `t.Fatalf` | 83:6 |
| `Identity` | 86:7 |
| `result.ExecutionTerms.Policy` | 86:7 |
| `t.Fatal` | 87:5 |
| `result.ExecutionTerms.Policy` | 90:15 |
| `policy.StagedTargetMinor` | 91:8 |
| `policy.FairValueMinor` | 91:48 |
| `policy.EntryCostsMinor` | 91:90 |
| `policy.ExitCostsMinor` | 91:125 |
| `policy.MinimumRRPPM` | 91:159 |
| `policy.DecisionDigest` | 91:189 |
| `policy.CalendarDigest` | 91:222 |
| `policy.CapSnapshotID` | 91:255 |
| `policy.Identity` | 91:327 |
| `t.Fatalf` | 92:6 |
| `approved.EvidenceDigest` | 99:47 |
| `t.Fatalf` | 101:5 |
| `t.Fatalf` | 104:5 |
| `result.ValidProposal` | 106:7 |
| `t.Fatal` | 107:5 |
| `Propose` | 109:16 |
| `proposal.ValidProposal` | 110:40 |
| `proposal.ExecutionTerms.Quantity` | 111:5 |
| `t.Fatalf` | 114:5 |
| `CapSnapshotID` | 116:55 |
| `proposal.ExecutionTerms.Policy` | 116:55 |
| `t.Fatalf` | 117:5 |
| `proposal.ExecutionTerms.Policy` | 117:69 |
| `tampered.ValidProposal` | 121:7 |
| `t.Fatal` | 122:5 |
| `FinalizeProposalQuantity` | 124:17 |
| `final.ValidProposal` | 125:55 |
| `final.ExecutionTerms.Valid` | 125:81 |
| `final.ExecutionTerms.Quantity` | 126:5 |
| `final.ExecutionTerms.Entry` | 127:5 |
| `proposal.ExecutionTerms.Entry` | 127:37 |
| `final.ExecutionTerms.EffectiveStop` | 127:72 |
| `proposal.ExecutionTerms.EffectiveStop` | 127:112 |
| `final.ExecutionTerms.Target` | 128:5 |
| `proposal.ExecutionTerms.Target` | 128:38 |
| `final.ExecutionTerms.Policy` | 128:74 |
| `proposal.ExecutionTerms.Policy` | 128:107 |
| `t.Fatalf` | 129:5 |
| `descriptorByID` | 131:18 |
| `t.Fatalf` | 133:5 |
