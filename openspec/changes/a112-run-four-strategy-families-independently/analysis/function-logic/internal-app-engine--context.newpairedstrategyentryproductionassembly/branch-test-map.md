...
| B4 | if at 301:3 | planned targeted RED before any edit; not run by L0 | no | no |
| B5 | range at 318:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B6 | if at 323:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B7 | if at 330:2 | planned targeted RED before any edit; not run by L0 | no | no |
