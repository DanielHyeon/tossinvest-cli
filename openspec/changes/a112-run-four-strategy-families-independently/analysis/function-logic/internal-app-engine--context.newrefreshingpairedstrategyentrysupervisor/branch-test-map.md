...
|---|---|---|---|---|
| B1 | if at 372:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B2 | range at 376:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B3 | if at 388:2 | planned targeted RED before any edit; not run by L0 | no | no |
