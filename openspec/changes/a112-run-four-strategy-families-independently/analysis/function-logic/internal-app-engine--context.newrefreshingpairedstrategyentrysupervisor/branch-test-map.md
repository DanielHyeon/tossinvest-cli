...
|---|---|---|---|---|
| B1 | if at 339:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B2 | range at 343:2 | planned targeted RED before any edit; not run by L0 | no | no |
| B3 | if at 355:2 | planned targeted RED before any edit; not run by L0 | no | no |
