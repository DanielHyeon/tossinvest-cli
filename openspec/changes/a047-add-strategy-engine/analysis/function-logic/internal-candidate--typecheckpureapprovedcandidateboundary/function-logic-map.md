...
|---|---|---|---|---|
| B1 | follows the complete AST branch list in `ast.json`; walks imports, declarations, types, assignments, calls, and control-flow capabilities at the pure approval boundary | test-local collections only | deterministic finding/result | `TestApprovedCandidateConsumersStayInsidePureBoundaries` |
