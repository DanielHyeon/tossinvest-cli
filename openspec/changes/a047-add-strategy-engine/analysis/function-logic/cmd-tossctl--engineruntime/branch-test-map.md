...
| A047 | missing source/protection/provenance/scheduler keeps strategy loop absent while exit remains | a047 dormant runtime/static tests (to add in RED) | pending | no |
