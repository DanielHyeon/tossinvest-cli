...
- Inputs are the parameters in `reserveConfirmedSweepOrder(params=6, results=1)` and receiver state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/reservation_sweep_test.go:136 | Preserve the explicit condition, early return, and fail-closed error behavior. |
