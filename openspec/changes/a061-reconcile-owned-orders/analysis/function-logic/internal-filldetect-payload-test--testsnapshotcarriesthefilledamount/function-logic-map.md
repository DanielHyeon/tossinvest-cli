...
- Inputs are the parameters in `TestSnapshotCarriesTheFilledAmount(params=1, results=0)` and receiver state.
...
| --- | --- | --- | --- |
| B1 | if | internal/filldetect/payload_test.go:48 | Preserve the explicit condition, early return, and fail-closed error behavior. |
