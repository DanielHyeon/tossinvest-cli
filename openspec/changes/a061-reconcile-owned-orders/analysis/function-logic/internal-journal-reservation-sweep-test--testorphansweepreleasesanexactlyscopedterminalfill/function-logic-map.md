# Function Logic Map: `TestOrphanSweepReleasesAnExactlyScopedTerminalFill`

Source: `internal/journal/reservation_sweep_test.go`  
Function: `TestOrphanSweepReleasesAnExactlyScopedTerminalFill`  
Signature: `TestOrphanSweepReleasesAnExactlyScopedTerminalFill(params=1, results=0)`  
Source SHA-256: `489ced650b9f96b30419ecc9c21f7911145af1a973372a7f167edb61cfcbdcab`

## Inputs and invariants

- Inputs are the parameters represented by `TestOrphanSweepReleasesAnExactlyScopedTerminalFill(params=1, results=0)` and any receiver state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/reservation_sweep_test.go:192 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
| B2 | if | internal/journal/reservation_sweep_test.go:195 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
| B3 | if | internal/journal/reservation_sweep_test.go:198 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
