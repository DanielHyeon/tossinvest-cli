...
- Inputs are the parameters represented by `insertTerminalFillSnapshot(params=8, results=0)` and any receiver state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/reservation_sweep_test.go:121 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
