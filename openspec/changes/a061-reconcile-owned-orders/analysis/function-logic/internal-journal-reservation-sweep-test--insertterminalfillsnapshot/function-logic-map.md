...
- Inputs are the parameters in `insertTerminalFillSnapshot(params=8, results=0)` and receiver state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/reservation_sweep_test.go:121 | Preserve the explicit condition, early return, and fail-closed error behavior. |
