...
- Inputs are the parameters represented by `fillOf(params=3, results=1)` and any receiver state.
...
| --- | --- | --- | --- |
| B1 | happy path | internal/journal/position_projection_test.go:97 | Execute the function contract without an alternate branch. |
