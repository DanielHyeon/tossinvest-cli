...
- Inputs are the parameters in `snapshotOrderKey(params=1, results=2)` and receiver state.
...
| --- | --- | --- | --- |
| B1 | happy path | internal/filldetect/detect.go:496 | Execute the function contract without an alternate branch. |
