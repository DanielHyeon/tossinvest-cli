...
- Inputs are `testIntentFor(params=1, results=1)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | happy path | internal/journal/position_projection_test.go:393 | Preserve the source-bound happy path and propagated errors. |
