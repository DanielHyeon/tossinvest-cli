# Function Logic Map: `TestSuccessfulForeignCauseResolutionClearsItsSymbolGate`

Source: `internal/reconcile/restore_test.go`  
Function: `TestSuccessfulForeignCauseResolutionClearsItsSymbolGate`  
Signature: `TestSuccessfulForeignCauseResolutionClearsItsSymbolGate(params=1, results=0)`  
Source SHA-256: `06075e0e4501b78ee04e55e617309bf70a7b1a025c31d7a496cd9396161bc2ab`

## Inputs and invariants

- Inputs are the parameters represented by `TestSuccessfulForeignCauseResolutionClearsItsSymbolGate(params=1, results=0)` and any receiver state.
...
| --- | --- | --- | --- |
| B1 | if | internal/reconcile/restore_test.go:686 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
| B2 | if | internal/reconcile/restore_test.go:694 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
| B3 | if | internal/reconcile/restore_test.go:697 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
| B4 | if | internal/reconcile/restore_test.go:701 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
| B5 | if | internal/reconcile/restore_test.go:704 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
