...
- Inputs are `recordConfirmedLedgerOrder(params=3, results=0)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/filldetect/ledger_test.go:64 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | if | internal/filldetect/ledger_test.go:67 | Preserve the condition, error propagation, and fail-closed behavior. |
| B3 | if | internal/filldetect/ledger_test.go:70 | Preserve the condition, error propagation, and fail-closed behavior. |
| B4 | if | internal/filldetect/ledger_test.go:73 | Preserve the condition, error propagation, and fail-closed behavior. |
