...
- Inputs are `Journal.scopedLineageChildrenV16(params=3, results=2)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | happy path | internal/journal/lineage.go:375 | Preserve the source-bound happy path and propagated errors. |
