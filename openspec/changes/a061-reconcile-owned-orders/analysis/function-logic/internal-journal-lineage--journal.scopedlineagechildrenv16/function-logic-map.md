...
- Inputs are the parameters in `Journal.scopedLineageChildrenV16(params=3, results=2)` and receiver state.
...
- `j.queryScopedLineageChildren`: returned errors and state follow the mapped branches.
