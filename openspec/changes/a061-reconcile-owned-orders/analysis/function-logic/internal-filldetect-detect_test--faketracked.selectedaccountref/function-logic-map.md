...
- Inputs are `fakeTracked.SelectedAccountRef(params=0, results=1)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/filldetect/detect_test.go:154 | Preserve the condition, error propagation, and fail-closed behavior. |
