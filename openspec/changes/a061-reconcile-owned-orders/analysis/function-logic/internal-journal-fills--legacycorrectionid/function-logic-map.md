# Function Logic Map: `legacyCorrectionID`

Source: `internal/journal/fills.go`
Function: `legacyCorrectionID`
Signature: `legacyCorrectionID(params=1, results=1)`
Source SHA-256: `000918b94c8c3f776b611421c412e4604086fc4cbee2fd0e7c21fe0dd46454c0`
Revision: `current`

## Inputs and invariants

- Inputs are `legacyCorrectionID(params=1, results=1)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | range | internal/journal/fills.go:1222 | Preserve the condition, error propagation, and fail-closed behavior. |
