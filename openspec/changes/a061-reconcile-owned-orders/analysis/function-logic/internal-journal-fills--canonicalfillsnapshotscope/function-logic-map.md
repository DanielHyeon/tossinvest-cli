...
- Inputs are the parameters in `canonicalFillSnapshotScope(params=1, results=1)` and receiver state.
...
| --- | --- | --- | --- |
| B1 | happy path | internal/journal/fills.go:222 | Execute the function contract without an alternate branch. |
