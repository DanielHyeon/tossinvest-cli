# Function Logic Map: `TestTrackedFillOrdersRejectMalformedLegacyLineageOwnership`

Source: `internal/journal/fills_test.go`  
Function: `TestTrackedFillOrdersRejectMalformedLegacyLineageOwnership`  
Signature: `TestTrackedFillOrdersRejectMalformedLegacyLineageOwnership(params=1, results=0)`  
Source SHA-256: `2004cd42dcb970e432f53ccef544de09a592485a848c3bf492015b5a4c67fbbb`

## Inputs and invariants

- Inputs are the parameters represented by `TestTrackedFillOrdersRejectMalformedLegacyLineageOwnership(params=1, results=0)` and any receiver state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/fills_test.go:854 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
| B2 | if | internal/journal/fills_test.go:859 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
| B3 | if | internal/journal/fills_test.go:869 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
| B4 | if | internal/journal/fills_test.go:872 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
