...
- Inputs are the parameters in `OrderIdentity.canonical(params=0, results=1)` and receiver state.
...
| --- | --- | --- | --- |
| B1 | happy path | internal/reconcile/compare.go:70 | Execute the function contract without an alternate branch. |
