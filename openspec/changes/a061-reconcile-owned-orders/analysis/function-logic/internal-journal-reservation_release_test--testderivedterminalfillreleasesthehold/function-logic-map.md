...
- Inputs are `TestDerivedTerminalFillReleasesTheHold(params=1, results=0)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/reservation_release_test.go:167 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | if | internal/journal/reservation_release_test.go:180 | Preserve the condition, error propagation, and fail-closed behavior. |
| B3 | if | internal/journal/reservation_release_test.go:183 | Preserve the condition, error propagation, and fail-closed behavior. |
| B4 | if | internal/journal/reservation_release_test.go:187 | Preserve the condition, error propagation, and fail-closed behavior. |
