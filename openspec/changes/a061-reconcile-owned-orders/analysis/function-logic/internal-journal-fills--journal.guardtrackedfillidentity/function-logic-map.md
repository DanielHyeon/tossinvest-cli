...
- Inputs are the parameters represented by `Journal.guardTrackedFillIdentity(params=2, results=1)` and any receiver state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/fills.go:1084 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
| B2 | if | internal/journal/fills.go:1087 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
| B3 | if | internal/journal/fills.go:1092 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
