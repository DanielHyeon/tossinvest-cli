...
- Inputs are the parameters represented by `Journal.legacyScopedLineageChildren(params=3, results=2)` and any receiver state.
...
| --- | --- | --- | --- |
| B1 | happy path | internal/journal/lineage.go:398 | Execute the function contract without an alternate branch. |
