...
- Inputs are the parameters in `sameSnapshot(params=2, results=1)` and receiver state.
...
| --- | --- | --- | --- |
| B1 | happy path | internal/journal/fills.go:694 | Execute the function contract without an alternate branch. |
