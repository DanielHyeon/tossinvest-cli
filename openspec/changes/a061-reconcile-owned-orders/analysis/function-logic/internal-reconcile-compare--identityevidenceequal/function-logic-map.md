...
- Inputs are `identityEvidenceEqual(params=2, results=1)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | happy path | internal/reconcile/compare.go:551 | Preserve the source-bound happy path and propagated errors. |
