...
- Inputs are the parameters represented by `retryingEnterStore.EnterReconcile(params=2, results=3)` and any receiver state.
...
| --- | --- | --- | --- |
| B1 | if | internal/reconcile/restore_test.go:84 | Preserve the explicit condition, early return, and fail-closed error behavior at this branch. |
