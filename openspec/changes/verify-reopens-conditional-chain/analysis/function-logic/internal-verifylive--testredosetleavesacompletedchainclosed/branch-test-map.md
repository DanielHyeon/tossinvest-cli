# Branch Test Map: `TestRedoSetLeavesACompletedChainClosed`
...
|---|---|---|---|---|
| B1 | `if` line 185: `if has(RedoSet(entries), StepConditionalRegister) {` | `TestRedoSetLeavesACompletedChainClosed` | no | yes |
