...
| B2 | `engine_not_running` (a061) maps to its own sentence | `TestAStoppedEngineClosesTheProtectionLine` | yes | yes |
| B3 | `snapshot_quarantined` (a061) maps to its own sentence | `TestAQuarantinedPositionIsNotDrawnAsProtected` | yes | yes |
