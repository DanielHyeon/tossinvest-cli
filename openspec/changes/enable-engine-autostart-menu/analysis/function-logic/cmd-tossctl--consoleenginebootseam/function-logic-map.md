# Function Logic Map: `consoleEngineBootSeam`
...
|---|---|---|---|---|
| B1 | if at line 542 | Only the guarded return/call in `consoleEngineBootSeam` | branch result or propagated error | console seam and static authority tests |
...
- Safe edit boundary: `consoleEngineBootSeam` and its typed seam only.
