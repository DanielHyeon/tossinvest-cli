# Function Logic Map: `TestBothButtonsAskAboutThisProfilesJournal`
...
|---|---|---|---|---|
| B1 | if at line 603 | 없음 — 테스트 코드 | unchanged behaviour | `TestBothButtonsAskAboutThisProfilesJournal` (this function is the test) |
| B2 | if at line 606 | 없음 — 테스트 코드 | unchanged behaviour | `TestBothButtonsAskAboutThisProfilesJournal` (this function is the test) |
| B3 | if at line 609 | 없음 — 테스트 코드 | unchanged behaviour | `TestBothButtonsAskAboutThisProfilesJournal` (this function is the test) |
