# Function Logic Map: `TestNoEngineToStopIsNotAFailure`
...
|---|---|---|---|---|
| B1 | if at line 419 | 없음 — 테스트 코드 | unchanged behaviour | `TestNoEngineToStopIsNotAFailure` (this function is the test) |
| B2 | if at line 422 | 없음 — 테스트 코드 | unchanged behaviour | `TestNoEngineToStopIsNotAFailure` (this function is the test) |
