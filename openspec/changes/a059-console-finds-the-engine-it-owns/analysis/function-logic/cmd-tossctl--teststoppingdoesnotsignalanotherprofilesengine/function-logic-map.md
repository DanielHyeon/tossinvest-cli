# Function Logic Map: `TestStoppingDoesNotSignalAnotherProfilesEngine`
...
|---|---|---|---|---|
| B1 | if at line 533 | 없음 — 테스트 코드 | unchanged behaviour | `TestStoppingDoesNotSignalAnotherProfilesEngine` (this function is the test) |
| B2 | if at line 536 | 없음 — 테스트 코드 | unchanged behaviour | `TestStoppingDoesNotSignalAnotherProfilesEngine` (this function is the test) |
| B3 | if at line 539 | 없음 — 테스트 코드 | unchanged behaviour | `TestStoppingDoesNotSignalAnotherProfilesEngine` (this function is the test) |
| B4 | if at line 542 | 없음 — 테스트 코드 | unchanged behaviour | `TestStoppingDoesNotSignalAnotherProfilesEngine` (this function is the test) |
