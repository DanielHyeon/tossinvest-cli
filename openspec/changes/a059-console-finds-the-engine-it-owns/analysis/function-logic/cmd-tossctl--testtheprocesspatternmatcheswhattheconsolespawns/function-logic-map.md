# Function Logic Map: `TestTheProcessPatternMatchesWhatTheConsoleSpawns`
...
|---|---|---|---|---|
| B1 | if at line 646 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheProcessPatternMatchesWhatTheConsoleSpawns` (this function is the test) |
| B2 | range at line 649 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheProcessPatternMatchesWhatTheConsoleSpawns` (this function is the test) |
| B3 | if at line 662 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheProcessPatternMatchesWhatTheConsoleSpawns` (this function is the test) |
