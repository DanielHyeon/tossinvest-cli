...
|---|---|---|---|---|
| B1 | if at line 441 | 없음 — 테스트 코드 | unchanged behaviour | 이 함수를 통과하는 `cmd/tossctl` 테스트 |
| B2 | range at line 444 | 없음 — 테스트 코드 | unchanged behaviour | 이 함수를 통과하는 `cmd/tossctl` 테스트 |
| B3 | if at line 445 | 없음 — 테스트 코드 | unchanged behaviour | 이 함수를 통과하는 `cmd/tossctl` 테스트 |
