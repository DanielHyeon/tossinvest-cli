# Function Logic Map: `holdEngineMarker`
...
- Source: `internal/console/engineproc_test.go` (68-75)
- AST evidence: `ast.json` — AST 기준 branches **1** / returns 0 / calls 5
- Risk scan: `risk-pattern-report.md`
- source SHA-256: `bea466d1c23a836bce431418cd5a3a9dcce6fa4971bc3afc519e24ca52479df4`
- **a102가 바꾼 것**: `enginelock.Hold`의 D4 반환(핸들)에 맞춰 수신 변수와 `t.Cleanup` 인자를 바꿨다. 헬퍼의 계약은 그대로다.
...
|---|---|---|---|
| B1 | `:71` if | 테스트 코드 — 부수효과 없음 | 이 change로 바뀌지 않음 |
