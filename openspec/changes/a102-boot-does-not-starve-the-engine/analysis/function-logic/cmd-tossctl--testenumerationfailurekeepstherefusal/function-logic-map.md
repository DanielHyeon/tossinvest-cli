...
- Source: `cmd/tossctl/engineproc_test.go` (233-250)
...
|---|---|---|---|
| B1 | `:236` if | 테스트 코드 — 부수효과 없음 | 이 change로 바뀌지 않음 |
| B2 | `:244` if | 테스트 코드 — 부수효과 없음 | 이 change로 바뀌지 않음 |
| B3 | `:247` if | 테스트 코드 — 부수효과 없음 | 이 change로 바뀌지 않음 |
