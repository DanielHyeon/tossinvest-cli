...
| B2 | `engine_not_running` (a077) | returns one operator sentence | falls out of the switch | `TestAStoppedEngineClosesTheProtectionLine` |
| B3 | `snapshot_quarantined` (a077) | returns one operator sentence | falls out of the switch | `TestAQuarantinedPositionIsNotDrawnAsProtected` |
...
**a077 adds B2 and B3** at the top of the switch and changes nothing else. Cases
