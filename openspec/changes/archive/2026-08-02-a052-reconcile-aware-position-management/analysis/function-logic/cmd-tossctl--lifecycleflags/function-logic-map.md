# Function Logic Map: `lifecycleFlags`
...
|---|---|---|---|
| Function contract | `lifecycleFlags(params=2, results=2)` | current Go signature and callers | errors/unknown values propagate without inventing effective state |
...
|---|---|---|---|---|---|
| B1 | `if` at line 183 | `if !known {` | none beyond calls | early return/error nearby | go test ./cmd/tossctl |
