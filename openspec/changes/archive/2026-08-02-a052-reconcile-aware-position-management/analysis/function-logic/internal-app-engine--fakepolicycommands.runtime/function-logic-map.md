# Function Logic Map: `fakePolicyCommands.Runtime`
...
|---|---|---|---|
| Function contract | `fakePolicyCommands.Runtime(params=1, results=2)` | current Go signature and callers | errors/unknown values propagate without inventing effective state |
...
|---|---|---|---|---|---|
| B1 | branchless happy path | execute `fakePolicyCommands.Runtime(params=1, results=2)` | deterministic value/call effects only | normal function result | fakePolicyCommands.Runtime |
