# Function Logic Map: `httpAPIReader.validate`
...
|---|---|---|---|
| Function contract | `httpAPIReader.validate(params=0, results=1)` | current Go signature and callers | errors/unknown values propagate without inventing effective state |
...
|---|---|---|---|---|---|
| B1 | `if` at line 479 | `if r == nil \|\| r.holdings == nil \|\| r.orders == nil \|\| r.signals == nil \|\| r.accountRef == nil \|\|` | none beyond calls | early return/error nearby | go test ./cmd/tossctl |

## Calls and live bindings

| Callee | Why called | Error/timeout/retry contract | Evidence |
|---|---|---|---|
| `fmt.Errorf` | explicit dependency at line 481 | result/error follows the AST-recorded branch; no hidden retry is assumed | current AST + focused tests |

## State mutations and fallbacks

- AST records 0 assignment(s), 2 return statement(s), and 0 goroutine launch(es).
