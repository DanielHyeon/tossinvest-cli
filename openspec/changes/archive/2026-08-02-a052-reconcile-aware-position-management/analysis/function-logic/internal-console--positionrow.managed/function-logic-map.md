# Function Logic Map: `positionRow.Managed`
...
|---|---|---|---|
| Function contract | `positionRow.Managed(params=0, results=1)` | current Go signature and callers | errors/unknown values propagate without inventing effective state |
...
|---|---|---|---|---|---|
| B1 | `if` at line 323 | `if r.LifecycleKnown {` | none beyond calls listed below | early return/error path nearby | go test ./internal/console |
