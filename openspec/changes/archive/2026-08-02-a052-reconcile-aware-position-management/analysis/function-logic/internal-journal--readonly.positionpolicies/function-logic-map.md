# Function Logic Map: `ReadOnly.PositionPolicies`
...
|---|---|---|---|
| Function contract | `ReadOnly.PositionPolicies(params=1, results=2)` | current Go signature and callers | errors/unknown values propagate without inventing effective state |
...
|---|---|---|---|---|---|
| B1 | branchless happy path | execute `ReadOnly.PositionPolicies(params=1, results=2)` | deterministic value/call effects only | normal function result | TestReadOnlyPositionPoliciesPreservesReleasedLifecycle; TestTheReadOnlyHandleHasNoWriteMethods |

## Calls and live bindings

| Callee | Why called | Error/timeout/retry contract | Evidence |
|---|---|---|---|
| `queryPositionPolicies` | execute the explicit dependency at line 77 | callee result/error is handled by the AST-recorded branch; no hidden retry is assumed | current AST + focused package tests |
