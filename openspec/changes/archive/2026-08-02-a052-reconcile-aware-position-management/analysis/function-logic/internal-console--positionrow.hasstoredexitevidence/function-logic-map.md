# Function Logic Map: `positionRow.HasStoredExitEvidence`
...
|---|---|---|---|
| Function contract | `positionRow.HasStoredExitEvidence(params=0, results=1)` | current Go signature and callers | errors/unknown values propagate without inventing effective state |
...
|---|---|---|---|---|---|
| B1 | branchless happy path | execute `positionRow.HasStoredExitEvidence(params=0, results=1)` | deterministic value/call effects only | normal function result | go test ./internal/console |
