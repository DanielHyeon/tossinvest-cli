# Function Logic Map: `driverHarness.position`
...
|---|---|---|---|
| Function contract | `driverHarness.position(params=1, results=1)` | current Go signature and callers | errors/unknown values propagate without inventing effective state |
...
|---|---|---|---|---|---|
| B1 | branchless happy path | execute `driverHarness.position(params=1, results=1)` | deterministic value/call effects only | normal function result | driverHarness.position |

## Calls and live bindings

| Callee | Why called | Error/timeout/retry contract | Evidence |
|---|---|---|---|
| `h.positionMarket` | execute the explicit dependency at line 218 | callee result/error is handled by the AST-recorded branch; no hidden retry is assumed | current AST + focused package tests |
