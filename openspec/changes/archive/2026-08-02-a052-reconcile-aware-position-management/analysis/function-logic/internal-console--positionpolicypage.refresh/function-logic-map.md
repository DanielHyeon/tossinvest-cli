# Function Logic Map: `positionPolicyPage.Refresh`
...
|---|---|---|---|
| Function contract | `positionPolicyPage.Refresh(params=0, results=1)` | current Go signature and callers | errors/unknown values propagate without inventing effective state |
...
|---|---|---|---|---|---|
| B1 | branchless happy path | execute base revision | deterministic effects only | normal result | positionPolicyPage.Refresh |

## Calls and live bindings

| Callee | Why called | Error/timeout/retry contract | Evidence |
|---|---|---|---|
| none | pure/field-selection behavior | no timeout or retry surface | base AST |

## State mutations and fallbacks

- Base AST records 0 assignment(s), 1 return statement(s), and 0 goroutine launch(es).
