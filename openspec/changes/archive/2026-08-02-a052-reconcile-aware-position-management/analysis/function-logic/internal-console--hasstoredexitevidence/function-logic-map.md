...
|---|---|---|---|---|---|
| B1 | branchless happy path | execute `hasStoredExitEvidence(params=1, results=1)` | deterministic effects only | normal result | go test ./internal/console |

## Calls and live bindings

| Callee | Why called | Error/timeout/retry contract | Evidence |
|---|---|---|---|
| `strings.TrimSpace` | explicit dependency at line 146 | result/error follows the AST-recorded branch; no hidden retry is assumed | current AST + focused tests |
