# Function Logic Map: `TestTrustedNetworkStillRejectsWrongPeerOriginAndCSRF`
...
|---|---|---|---|---|
| B1 | if at line 207 | none; test code | unchanged behaviour | `TestTrustedNetworkStillRejectsWrongPeerOriginAndCSRF` (this function is the test) |
| B2 | if at line 219 | none; test code | unchanged behaviour | `TestTrustedNetworkStillRejectsWrongPeerOriginAndCSRF` (this function is the test) |
| B3 | if at line 231 | none; test code | unchanged behaviour | `TestTrustedNetworkStillRejectsWrongPeerOriginAndCSRF` (this function is the test) |
