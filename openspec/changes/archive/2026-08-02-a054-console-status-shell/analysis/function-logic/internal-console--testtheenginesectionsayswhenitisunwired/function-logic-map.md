# Function Logic Map: `TestTheEngineSectionSaysWhenItIsUnwired`
...
|---|---|---|---|---|
| B1 | if at line 124 | none; test code | unchanged behaviour | `TestTheEngineSectionSaysWhenItIsUnwired` (this function is the test) |
| B2 | if at line 127 | none; test code | unchanged behaviour | `TestTheEngineSectionSaysWhenItIsUnwired` (this function is the test) |
