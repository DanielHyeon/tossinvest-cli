# Function Logic Map: `TestRemoteSessionHasAnAbsoluteExpiryDespiteActivity`
...
|---|---|---|---|---|
| B1 | for at line 370 | none; test code | unchanged behaviour | `TestRemoteSessionHasAnAbsoluteExpiryDespiteActivity` (this function is the test) |
| B2 | if at line 374 | none; test code | unchanged behaviour | `TestRemoteSessionHasAnAbsoluteExpiryDespiteActivity` (this function is the test) |
| B3 | if at line 381 | none; test code | unchanged behaviour | `TestRemoteSessionHasAnAbsoluteExpiryDespiteActivity` (this function is the test) |
