# Function Logic Map: `TestTheStaleEngineBinaryIsWarnedAbout`
...
|---|---|---|---|---|
| B1 | if at line 357 | none; test code | unchanged behaviour | `TestTheStaleEngineBinaryIsWarnedAbout` (this function is the test) |
