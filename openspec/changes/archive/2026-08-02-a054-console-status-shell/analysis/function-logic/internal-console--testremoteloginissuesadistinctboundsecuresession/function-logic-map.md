# Function Logic Map: `TestRemoteLoginIssuesADistinctBoundSecureSession`
...
|---|---|---|---|---|
| B1 | if at line 320 | none; test code | unchanged behaviour | `TestRemoteLoginIssuesADistinctBoundSecureSession` (this function is the test) |
| B2 | if at line 323 | none; test code | unchanged behaviour | `TestRemoteLoginIssuesADistinctBoundSecureSession` (this function is the test) |
| B3 | if at line 326 | none; test code | unchanged behaviour | `TestRemoteLoginIssuesADistinctBoundSecureSession` (this function is the test) |
| B4 | if at line 332 | none; test code | unchanged behaviour | `TestRemoteLoginIssuesADistinctBoundSecureSession` (this function is the test) |
| B5 | if at line 337 | none; test code | unchanged behaviour | `TestRemoteLoginIssuesADistinctBoundSecureSession` (this function is the test) |
