# Function Logic Map: `TestAStaleMarkerReadsAsStopped`
...
|---|---|---|---|---|
| B1 | if at line 112 | none; test code | unchanged behaviour | `TestAStaleMarkerReadsAsStopped` (this function is the test) |
