# Function Logic Map: `TestARestartWithNoWiringSaysSoInsteadOfPretending`
...
|---|---|---|---|---|
| B1 | if at line 197 | none; test code | unchanged behaviour | `TestARestartWithNoWiringSaysSoInsteadOfPretending` (this function is the test) |
| B2 | if at line 200 | none; test code | unchanged behaviour | `TestARestartWithNoWiringSaysSoInsteadOfPretending` (this function is the test) |
| B3 | if at line 206 | none; test code | unchanged behaviour | `TestARestartWithNoWiringSaysSoInsteadOfPretending` (this function is the test) |
