# Function Logic Map: `TestStoppingGoesThroughTheSignalDiscipline`
...
|---|---|---|---|---|
| B1 | if at line 297 | none; test code | unchanged behaviour | `TestStoppingGoesThroughTheSignalDiscipline` (this function is the test) |
| B2 | if at line 300 | none; test code | unchanged behaviour | `TestStoppingGoesThroughTheSignalDiscipline` (this function is the test) |
| B3 | if at line 304 | none; test code | unchanged behaviour | `TestStoppingGoesThroughTheSignalDiscipline` (this function is the test) |
