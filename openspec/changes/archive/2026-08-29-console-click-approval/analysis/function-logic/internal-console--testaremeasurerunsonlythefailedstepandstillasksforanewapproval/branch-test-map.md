# Branch Test Map: `TestARemeasureRunsOnlyTheFailedStepAndStillAsksForANewApproval`
...
| B2 | `if view.Batch == nil {` (internal/console/remeasure_test.go:142) | 이 함수 자체가 테스트다 | yes | yes |
