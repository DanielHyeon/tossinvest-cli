...
|---|---|---|---|---|
| B1 | `if` line 156: `if a.HeldUntil != "" {` | `holdGate` 계열 테스트 | 아래 RED 기록 | yes |
| B2 | `if` line 159: `if a.Kind == KindConditional {` | `holdGate` 계열 테스트 | 아래 RED 기록 | yes |
