...
- Inputs are `reserveConfirmedSweepOrder(params=6, results=1)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/reservation_sweep_test.go:176 | Preserve the condition, error propagation, and fail-closed behavior. |
