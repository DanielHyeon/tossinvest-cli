...
- Inputs are `TestCollidingConfirmedOrderIdentityBlocksWithoutProjectingAPosition(params=1, results=0)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/position_projection_test.go:187 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | if | internal/journal/position_projection_test.go:190 | Preserve the condition, error propagation, and fail-closed behavior. |
| B3 | if | internal/journal/position_projection_test.go:194 | Preserve the condition, error propagation, and fail-closed behavior. |
| B4 | if | internal/journal/position_projection_test.go:197 | Preserve the condition, error propagation, and fail-closed behavior. |
