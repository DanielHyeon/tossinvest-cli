...
- Inputs are `TestOrphanSweepReleasesAnExactlyScopedTerminalFill(params=1, results=0)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/reservation_sweep_test.go:232 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | if | internal/journal/reservation_sweep_test.go:235 | Preserve the condition, error propagation, and fail-closed behavior. |
| B3 | if | internal/journal/reservation_sweep_test.go:238 | Preserve the condition, error propagation, and fail-closed behavior. |
