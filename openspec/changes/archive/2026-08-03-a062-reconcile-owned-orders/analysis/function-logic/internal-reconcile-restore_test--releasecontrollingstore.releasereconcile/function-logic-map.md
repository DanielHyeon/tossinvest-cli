...
- Inputs are `releaseControllingStore.ReleaseReconcile(params=2, results=3)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | happy path | internal/reconcile/restore_test.go:96 | Preserve the source-bound happy path and propagated errors. |
