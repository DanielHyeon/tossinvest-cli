...
- Inputs are `trackedOrderKey(params=2, results=2)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/filldetect/detect.go:483 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | if | internal/filldetect/detect.go:488 | Preserve the condition, error propagation, and fail-closed behavior. |
