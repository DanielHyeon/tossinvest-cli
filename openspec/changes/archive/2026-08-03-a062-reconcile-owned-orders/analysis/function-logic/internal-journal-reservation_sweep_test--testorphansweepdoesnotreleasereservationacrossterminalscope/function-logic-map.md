...
- Inputs are `TestOrphanSweepDoesNotReleaseReservationAcrossTerminalScope(params=1, results=0)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | range | internal/journal/reservation_sweep_test.go:353 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | if | internal/journal/reservation_sweep_test.go:362 | Preserve the condition, error propagation, and fail-closed behavior. |
| B3 | if | internal/journal/reservation_sweep_test.go:365 | Preserve the condition, error propagation, and fail-closed behavior. |
| B4 | if | internal/journal/reservation_sweep_test.go:368 | Preserve the condition, error propagation, and fail-closed behavior. |
