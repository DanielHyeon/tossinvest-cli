...
- Inputs are `TestPollRejectsDuplicateTrackedCanonicalIdentity(params=1, results=0)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/filldetect/detect_test.go:499 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | if | internal/filldetect/detect_test.go:503 | Preserve the condition, error propagation, and fail-closed behavior. |
| B3 | if | internal/filldetect/detect_test.go:506 | Preserve the condition, error propagation, and fail-closed behavior. |
