...
- Inputs are `TestTrackedFillOrdersScopeReusedOrderIDsByAccount(params=1, results=0)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/fills_test.go:544 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | if | internal/journal/fills_test.go:547 | Preserve the condition, error propagation, and fail-closed behavior. |
| B3 | if | internal/journal/fills_test.go:550 | Preserve the condition, error propagation, and fail-closed behavior. |
| B4 | if | internal/journal/fills_test.go:553 | Preserve the condition, error propagation, and fail-closed behavior. |
| B5 | range | internal/journal/fills_test.go:557 | Preserve the condition, error propagation, and fail-closed behavior. |
| B6 | if | internal/journal/fills_test.go:559 | Preserve the condition, error propagation, and fail-closed behavior. |
| B7 | if | internal/journal/fills_test.go:562 | Preserve the condition, error propagation, and fail-closed behavior. |
