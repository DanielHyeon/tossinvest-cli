...
- Inputs are `TestTrackedFillOrdersDoNotBindLegacyLineageSnapshotAcrossReusedDays(params=1, results=0)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/fills_test.go:1427 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | if | internal/journal/fills_test.go:1431 | Preserve the condition, error propagation, and fail-closed behavior. |
