...
|---|---|---|---|---|
| none | branch-free seam; compatibility projection delegates through unavailable liveness without calculating a line | function-defined only | exact result | `TestA111HTTPAPIProjectionExactlyMatchesTheSharedOperatorVerdict` |
| Return | all admitted paths | compatibility projection delegates through unavailable liveness without calculating a line | exact function result | `TestA111HTTPAPIProjectionExactlyMatchesTheSharedOperatorVerdict` |

## Calls and live bindings

| Callee | Why called | Error/timeout/retry contract | Evidence |
|---|---|---|---|
| direct A111 time/evidence collaborators | compatibility projection delegates through unavailable liveness without calculating a line | no clock movement may extend a lease or upgrade a stopped marker | AST + named RED |

## State mutations and fallbacks

- compatibility projection delegates through unavailable liveness without calculating a line.
