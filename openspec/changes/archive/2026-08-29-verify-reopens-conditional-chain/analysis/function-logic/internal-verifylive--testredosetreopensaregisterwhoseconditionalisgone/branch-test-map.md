# Branch Test Map: `TestRedoSetReopensARegisterWhoseConditionalIsGone`
...
|---|---|---|---|---|
| B1 | `if` line 169: `if !has(RedoSet(entries), StepConditionalRegister) {` | `TestRedoSetReopensARegisterWhoseConditionalIsGone` | no | yes |
