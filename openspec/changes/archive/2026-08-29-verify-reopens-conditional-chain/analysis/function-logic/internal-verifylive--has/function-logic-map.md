# Function Logic Map: `has`

- Source: `internal/verifylive/redo_test.go`
- Function: `internal/verifylive/redo_test.go:has`
...
|---|---|---|---|---|
| B1 | `range` (line 150) — `for _, id := range ids {` | 없음 | 루프/분기 계속 | 아래 참조 |
| B2 | `if` (line 151) — `if id == want {` | 없음 | 루프/분기 계속 | 아래 참조 |
