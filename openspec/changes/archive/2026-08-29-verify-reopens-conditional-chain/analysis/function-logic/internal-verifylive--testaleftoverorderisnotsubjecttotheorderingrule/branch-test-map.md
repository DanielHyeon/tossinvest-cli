# Branch Test Map: `TestALeftoverOrderIsNotSubjectToTheOrderingRule`
...
|---|---|---|---|---|
| B1 | `if` line 337: `if len(got) != 1 \|\| got[0].Kind != KindOrder {` | `TestALeftoverOrderIsNotSubjectToTheOrderingRule` | no | yes |
