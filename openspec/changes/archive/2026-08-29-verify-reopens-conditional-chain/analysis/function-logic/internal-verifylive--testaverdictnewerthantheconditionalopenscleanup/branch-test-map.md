# Branch Test Map: `TestAVerdictNewerThanTheConditionalOpensCleanup`
...
|---|---|---|---|---|
| B1 | `if` line 313: `if len(got) != 1 \|\| got[0].ID != "grLKqiGuCVS7mj" {` | `TestAVerdictNewerThanTheConditionalOpensCleanup` | no | yes |
