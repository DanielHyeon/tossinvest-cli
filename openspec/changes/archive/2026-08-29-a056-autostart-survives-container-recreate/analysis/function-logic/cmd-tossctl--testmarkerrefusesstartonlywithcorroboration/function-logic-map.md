# Function Logic Map: `TestMarkerRefusesStartOnlyWithCorroboration`
...
|---|---|---|---|---|
| B1 | range at line 246 | 없음 — 테스트 코드 | unchanged behaviour | `TestMarkerRefusesStartOnlyWithCorroboration` (this function is the test) |
| B2 | if at line 259 | 없음 — 테스트 코드 | unchanged behaviour | `TestMarkerRefusesStartOnlyWithCorroboration` (this function is the test) |

## Calls and live bindings

| Callee | Why called | Error/timeout/retry contract | Evidence |
|---|---|---|---|
| see `ast.json` calls | 2 call sites, contract unchanged by this change | no retry introduced | AST + CodeGraph |
