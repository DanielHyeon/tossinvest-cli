...
|---|---|---|---|---|
| B1 | if at line 168 | 없음 — 테스트 코드 | unchanged behaviour | `TestAGhostMarkerDoesNotRefuseAStart` (this function is the test) |
| B2 | if at line 178 | 없음 — 테스트 코드 | unchanged behaviour | `TestAGhostMarkerDoesNotRefuseAStart` (this function is the test) |
| B3 | if at line 181 | 없음 — 테스트 코드 | unchanged behaviour | `TestAGhostMarkerDoesNotRefuseAStart` (this function is the test) |
