# Function Logic Map: `TestNoPathRefusesOnMarkerFreshnessAlone`
...
|---|---|---|---|---|
| B1 | if at line 280 | 없음 — 테스트 코드 | unchanged behaviour | `TestNoPathRefusesOnMarkerFreshnessAlone` (this function is the test) |
| B2 | if at line 285 | 없음 — 테스트 코드 | unchanged behaviour | `TestNoPathRefusesOnMarkerFreshnessAlone` (this function is the test) |
| B3 | if at line 290 | 없음 — 테스트 코드 | unchanged behaviour | `TestNoPathRefusesOnMarkerFreshnessAlone` (this function is the test) |
