# Function Logic Map: EntryGate.checkAccountEntry
...
|---|---|---|---|
| Function inputs and receiver state | Validated by implementation branches | internal/execgw/retry.go and package-owned authority | Fail closed; no broker authority is synthesized |
