# Function Logic Map: `TestACurrencyChangeIsNeitherTighteningNorLoosening`

- Source: `internal/console/settings_card_test.go`
- Qualified function: `TestACurrencyChangeIsNeitherTighteningNorLoosening`
...
|---|---|---|---|
| function inputs and fixture/runtime state | exact types and identities declared by the source revision | `internal/console/settings_card_test.go` plus its direct callers/tests | return/error or test assertion; no value is silently repaired |
