# Function Logic Map: `TestMigrationV22AddsOnlyAuthoritativeRiskBucketJournalState`

- Source: `internal/journal/risk_bucket_migration_test.go`
- Qualified function: `TestMigrationV22AddsOnlyAuthoritativeRiskBucketJournalState`
...
|---|---|---|---|
| function inputs and fixture/runtime state | exact types and identities declared by the source revision | `internal/journal/risk_bucket_migration_test.go` plus its direct callers/tests | return/error or test assertion; no value is silently repaired |
