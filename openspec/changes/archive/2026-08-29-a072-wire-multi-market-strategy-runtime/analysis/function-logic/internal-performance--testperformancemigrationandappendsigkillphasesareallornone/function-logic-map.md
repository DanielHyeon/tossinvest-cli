# Function Logic Map: `TestPerformanceMigrationAndAppendSIGKILLPhasesAreAllOrNone`

- Source: `internal/performance/crash_linux_test.go`
- Qualified function: `TestPerformanceMigrationAndAppendSIGKILLPhasesAreAllOrNone`
...
|---|---|---|---|
| function inputs and fixture/runtime state | exact types and identities declared by the source revision | `internal/performance/crash_linux_test.go` plus its direct callers/tests | return/error or test assertion; no value is silently repaired |
