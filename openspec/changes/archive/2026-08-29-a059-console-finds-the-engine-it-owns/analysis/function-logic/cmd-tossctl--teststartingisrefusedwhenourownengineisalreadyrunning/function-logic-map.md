# Function Logic Map: `TestStartingIsRefusedWhenOurOwnEngineIsAlreadyRunning`
...
|---|---|---|---|---|
| B1 | if at line 584 | 없음 — 테스트 코드 | unchanged behaviour | `TestStartingIsRefusedWhenOurOwnEngineIsAlreadyRunning` (this function is the test) |
| B2 | if at line 587 | 없음 — 테스트 코드 | unchanged behaviour | `TestStartingIsRefusedWhenOurOwnEngineIsAlreadyRunning` (this function is the test) |
| B3 | if at line 590 | 없음 — 테스트 코드 | unchanged behaviour | `TestStartingIsRefusedWhenOurOwnEngineIsAlreadyRunning` (this function is the test) |
