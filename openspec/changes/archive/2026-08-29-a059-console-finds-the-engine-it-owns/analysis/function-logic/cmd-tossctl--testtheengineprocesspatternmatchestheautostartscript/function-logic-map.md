# Function Logic Map: `TestTheEngineProcessPatternMatchesTheAutostartScript`
...
|---|---|---|---|---|
| B1 | if at line 698 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheEngineProcessPatternMatchesTheAutostartScript` (this function is the test) |
| B2 | if at line 703 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheEngineProcessPatternMatchesTheAutostartScript` (this function is the test) |
| B3 | if at line 709 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheEngineProcessPatternMatchesTheAutostartScript` (this function is the test) |
