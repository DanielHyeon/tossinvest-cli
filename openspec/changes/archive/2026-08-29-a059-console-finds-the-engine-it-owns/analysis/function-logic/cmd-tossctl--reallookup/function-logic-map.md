...
a059이 추가한 테스트 헬퍼. 프로세스 테이블만 가짜고 패턴·파싱·소유 판정은 전부 production 경로를 통과한다.

| Branch | Condition | Mutation/side effect | Return/error | Required test |
|---|---|---|---|---|
| B1 | 분기 없음 — 단일 경로 | 없음 — 테스트 코드 | unchanged behaviour | 이 함수를 통과하는 `cmd/tossctl` 테스트 |
