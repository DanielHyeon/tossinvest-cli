# Function Logic Map: `pgrepEngineLines`
...
a059이 추가한 열거 seam. `pgrep -a -f`로 pid와 명령줄을 함께 읽고, exit 1(매칭 없음)과 실행 실패를 계속 구분한다 — 후자는 부재가 아니다(a056 D3).

| Branch | Condition | Mutation/side effect | Return/error | Required test |
|---|---|---|---|---|
| B1 | if at line 326 | 없음 — 순수 함수 | unchanged behaviour | 이 함수를 통과하는 `cmd/tossctl` 테스트 |
| B2 | if at line 328 | 없음 — 순수 함수 | unchanged behaviour | 이 함수를 통과하는 `cmd/tossctl` 테스트 |
