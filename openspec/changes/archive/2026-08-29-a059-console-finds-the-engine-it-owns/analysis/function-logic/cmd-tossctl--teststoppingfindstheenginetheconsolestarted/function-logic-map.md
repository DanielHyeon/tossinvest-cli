# Function Logic Map: `TestStoppingFindsTheEngineTheConsoleStarted`
...
|---|---|---|---|---|
| B1 | if at line 560 | 없음 — 테스트 코드 | unchanged behaviour | `TestStoppingFindsTheEngineTheConsoleStarted` (this function is the test) |
| B2 | if at line 563 | 없음 — 테스트 코드 | unchanged behaviour | `TestStoppingFindsTheEngineTheConsoleStarted` (this function is the test) |
| B3 | if at line 567 | 없음 — 테스트 코드 | unchanged behaviour | `TestStoppingFindsTheEngineTheConsoleStarted` (this function is the test) |
