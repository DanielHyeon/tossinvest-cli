# Function Logic Map: `TestTheProcessPatternIgnoresTheOtherSubcommands`
...
|---|---|---|---|---|
| B1 | range at line 678 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheProcessPatternIgnoresTheOtherSubcommands` (this function is the test) |
| B2 | if at line 688 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheProcessPatternIgnoresTheOtherSubcommands` (this function is the test) |
