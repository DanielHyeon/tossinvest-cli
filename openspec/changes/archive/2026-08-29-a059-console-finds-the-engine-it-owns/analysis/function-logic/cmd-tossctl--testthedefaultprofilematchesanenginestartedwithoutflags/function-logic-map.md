# Function Logic Map: `TestTheDefaultProfileMatchesAnEngineStartedWithoutFlags`
...
|---|---|---|---|---|
| B1 | range at line 485 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheDefaultProfileMatchesAnEngineStartedWithoutFlags` (this function is the test) |
| B2 | if at line 495 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheDefaultProfileMatchesAnEngineStartedWithoutFlags` (this function is the test) |
