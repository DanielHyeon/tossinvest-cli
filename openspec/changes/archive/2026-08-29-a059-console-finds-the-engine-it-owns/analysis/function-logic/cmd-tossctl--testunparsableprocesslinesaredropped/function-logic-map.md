# Function Logic Map: `TestUnparsableProcessLinesAreDropped`
...
|---|---|---|---|---|
| B1 | if at line 514 | 없음 — 테스트 코드 | unchanged behaviour | `TestUnparsableProcessLinesAreDropped` (this function is the test) |
