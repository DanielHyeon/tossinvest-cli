...
|---|---|---|---|---|
| B1 | (무분기 happy path) | TestEveryStateChangingRouteAlsoGoesThroughTheCSRFGate(RED: 목록 불일치 관측)·TestNoRouteNamesAnAccountMutation·settings_test 전체 green | 해당(아래 기록) | yes |
