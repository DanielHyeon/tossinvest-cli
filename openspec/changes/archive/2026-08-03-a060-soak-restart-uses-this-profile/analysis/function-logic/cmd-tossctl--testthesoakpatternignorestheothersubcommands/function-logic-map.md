# Function Logic Map: `TestTheSoakPatternIgnoresTheOtherSubcommands`
...
|---|---|---|---|---|
| B1 | range at line 323 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheSoakPatternIgnoresTheOtherSubcommands` (this function is the test) |
| B2 | if at line 330 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheSoakPatternIgnoresTheOtherSubcommands` (this function is the test) |
