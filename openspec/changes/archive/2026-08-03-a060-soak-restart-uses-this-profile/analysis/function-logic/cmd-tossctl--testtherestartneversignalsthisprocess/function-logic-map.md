# Function Logic Map: `TestTheRestartNeverSignalsThisProcess`
...
|---|---|---|---|---|
| B1 | if at line 212 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheRestartNeverSignalsThisProcess` (this function is the test) |
| B2 | if at line 215 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheRestartNeverSignalsThisProcess` (this function is the test) |
