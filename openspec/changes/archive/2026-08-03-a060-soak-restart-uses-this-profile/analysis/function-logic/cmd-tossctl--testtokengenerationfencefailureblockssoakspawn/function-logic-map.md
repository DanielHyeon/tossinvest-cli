# Function Logic Map: `TestTokenGenerationFenceFailureBlocksSoakSpawn`
...
|---|---|---|---|---|
| B1 | if at line 40 | 없음 — 테스트 코드 | unchanged behaviour | `TestTokenGenerationFenceFailureBlocksSoakSpawn` (this function is the test) |
| B2 | if at line 43 | 없음 — 테스트 코드 | unchanged behaviour | `TestTokenGenerationFenceFailureBlocksSoakSpawn` (this function is the test) |
