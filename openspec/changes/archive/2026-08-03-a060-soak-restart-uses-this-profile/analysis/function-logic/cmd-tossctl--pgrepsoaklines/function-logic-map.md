# Function Logic Map: `pgrepSoakLines`
...
a060이 추가한 열거 seam. `pgrep -a -f`로 pid와 명령줄을 함께 읽고, exit 1(매칭 없음)과 실행 실패를 계속 구분한다.

| Branch | Condition | Mutation/side effect | Return/error | Required test |
|---|---|---|---|---|
| B1 | if at line 250 | 없음 — 순수 함수 | unchanged behaviour | 이 함수를 통과하는 `cmd/tossctl` 테스트 |
| B2 | if at line 252 | 없음 — 순수 함수 | unchanged behaviour | 이 함수를 통과하는 `cmd/tossctl` 테스트 |
