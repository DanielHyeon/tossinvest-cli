# Function Logic Map: `TestAFailureToLookForTheSoakIsReportedAndNothingIsStarted`
...
|---|---|---|---|---|
| B1 | if at line 226 | 없음 — 테스트 코드 | unchanged behaviour | `TestAFailureToLookForTheSoakIsReportedAndNothingIsStarted` (this function is the test) |
| B2 | if at line 229 | 없음 — 테스트 코드 | unchanged behaviour | `TestAFailureToLookForTheSoakIsReportedAndNothingIsStarted` (this function is the test) |
