# Function Logic Map: `TestTheRestartDoesNotSignalAnotherRecordsSoak`
...
|---|---|---|---|---|
| B1 | if at line 378 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheRestartDoesNotSignalAnotherRecordsSoak` (this function is the test) |
| B2 | if at line 381 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheRestartDoesNotSignalAnotherRecordsSoak` (this function is the test) |
