# Function Logic Map: `soakRecordForConfigDir`
...
명령줄의 --config-dir를 기록 경로로 바꾼다. 콘솔이 자기 것을 구할 때와 같은 resolveSoakRecord를 통과하므로, 기본 경로를 명시한 쪽과 생략한 쪽이 같은 서베이로 판정된다.

| Branch | Condition | Mutation/side effect | Return/error | Required test |
|---|---|---|---|---|
| B1 | if at line 132 | 없음 — 순수 함수 | unchanged behaviour | 이 함수를 통과하는 `cmd/tossctl` 테스트 |
