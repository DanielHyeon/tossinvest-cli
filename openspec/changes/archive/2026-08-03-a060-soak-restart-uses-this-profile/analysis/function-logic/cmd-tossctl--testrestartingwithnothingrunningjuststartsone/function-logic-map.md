# Function Logic Map: `TestRestartingWithNothingRunningJustStartsOne`
...
|---|---|---|---|---|
| B1 | if at line 170 | 없음 — 테스트 코드 | unchanged behaviour | `TestRestartingWithNothingRunningJustStartsOne` (this function is the test) |
| B2 | if at line 173 | 없음 — 테스트 코드 | unchanged behaviour | `TestRestartingWithNothingRunningJustStartsOne` (this function is the test) |
| B3 | if at line 176 | 없음 — 테스트 코드 | unchanged behaviour | `TestRestartingWithNothingRunningJustStartsOne` (this function is the test) |
| B4 | if at line 179 | 없음 — 테스트 코드 | unchanged behaviour | `TestRestartingWithNothingRunningJustStartsOne` (this function is the test) |
