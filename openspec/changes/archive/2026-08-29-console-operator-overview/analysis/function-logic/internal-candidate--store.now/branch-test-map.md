...
|---|---|---|---|---|
| B1 | (무분기·본문 무변경) 저장소의 주입된 시계를 돌려준다 | `TestACycleEnforcesRetentionItselfRatherThanLeavingItToACaller`(스윕이 `store.Now()`를 쓴다), `TestNothingInThisPackageAsksTheWallClockWhatTimeItIs` | — (동작 무변경) | yes |
