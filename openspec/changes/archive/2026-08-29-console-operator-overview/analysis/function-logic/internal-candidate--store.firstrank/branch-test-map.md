...
|---|---|---|---|---|
| B1 | 저장된 네 컬럼을 읽는다 | `TestPruningRawObservationsLeavesTheFirstRankToo` | 아니오(사후 증거) | yes |
| B2 | 모르는 후보는 found=false | `TestARankOfZeroIsNotAFirstSighting` | 아니오(사후 증거) | yes |
| B3 | 조회 실패 | 없음 | 아니오(사후 증거) | 미커버 |
