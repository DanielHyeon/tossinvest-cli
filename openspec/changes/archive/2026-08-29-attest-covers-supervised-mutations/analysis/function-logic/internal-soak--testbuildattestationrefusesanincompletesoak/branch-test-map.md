...
|---|---|---|---|---|
| B1 | `if` line 236: `if err == nil {` | `TestBuildAttestationRefusesAnIncompleteSoak` | no | yes |
| B2 | `if` line 239: `if !errors.Is(err, soak.ErrIncomplete) {` | `TestBuildAttestationRefusesAnIncompleteSoak` | no | yes |
