...
|---|---|---|---|---|
| B1 | if at line 92 | Only the guarded return/call in `engineOf` | branch result or propagated error | existing operating-config regression tests |
...
- Safe edit boundary: `engineOf` and its typed seam only.
