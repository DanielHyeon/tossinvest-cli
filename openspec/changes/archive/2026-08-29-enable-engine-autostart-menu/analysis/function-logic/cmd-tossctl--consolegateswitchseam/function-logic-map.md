...
|---|---|---|---|---|
| B1 | if at line 535 | Only the guarded return/call in `consoleGateSwitchSeam` | branch result or propagated error | console seam and static authority tests |
...
- Safe edit boundary: `consoleGateSwitchSeam` and its typed seam only.
