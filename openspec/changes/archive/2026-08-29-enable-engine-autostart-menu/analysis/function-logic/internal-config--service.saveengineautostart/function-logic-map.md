# Function Logic Map: `Service.SaveEngineAutostart`
...
|---|---|---|---|---|
| B1 | straight-line happy path | Function's declared return/write only | direct result | `TestAutostart*` config/console matrix |
...
- Safe edit boundary: `Service.SaveEngineAutostart` and its typed seam only.
