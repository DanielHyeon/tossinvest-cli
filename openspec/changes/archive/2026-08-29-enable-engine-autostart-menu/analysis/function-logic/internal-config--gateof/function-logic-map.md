...
|---|---|---|---|---|
| B1 | if at line 83 | Only the guarded return/call in `gateOf` | branch result or propagated error | existing operating-config regression tests |
...
- Safe edit boundary: `gateOf` and its typed seam only.
