# Function Logic Map: `fakeBroker.PriceLimits`
...
|---|---|---|---|---|
| B1 | `if symbol == usProbeSymbol {` (internal/console/fake_broker_test.go:115, if) | 아래 State mutations 참조 | 조건 불충족 시 조기 반환 또는 분기 | 이 함수 자체가 테스트다 |
