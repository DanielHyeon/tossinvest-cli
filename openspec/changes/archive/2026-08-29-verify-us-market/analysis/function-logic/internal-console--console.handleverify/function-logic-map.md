# Function Logic Map: `Console.handleVerify`
...
|---|---|---|---|---|
| B1 | 분기 없음 — 단일 경로 (internal/console/pages.go) | 아래 State mutations 참조 | 정상 반환 | internal/verifylive/us_market_test.go, internal/console/us_market_test.go 및 기존 패키지 테스트 |
