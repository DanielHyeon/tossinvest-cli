# Function Logic Map: `TestRemotePeerHostOriginAndCSRFAreIndependentGates`
...
|---|---|---|---|---|
| B1 | if at line 425 | none; test code | unchanged behaviour | `TestRemotePeerHostOriginAndCSRFAreIndependentGates` (this function is the test) |
| B2 | if at line 432 | none; test code | unchanged behaviour | `TestRemotePeerHostOriginAndCSRFAreIndependentGates` (this function is the test) |
| B3 | if at line 440 | none; test code | unchanged behaviour | `TestRemotePeerHostOriginAndCSRFAreIndependentGates` (this function is the test) |
| B4 | if at line 448 | none; test code | unchanged behaviour | `TestRemotePeerHostOriginAndCSRFAreIndependentGates` (this function is the test) |

## Calls and live bindings

| Callee | Why called | Error/timeout/retry contract | Evidence |
|---|---|---|---|
| see `ast.json` calls | 20 call sites, unchanged in contract by this change | no retry introduced | AST + CodeGraph |
