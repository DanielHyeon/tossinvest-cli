# Function Logic Map: `TestAPartialBlockSaysTheInterlockRefusesIt`
...
|---|---|---|---|---|
| B1 | range at line 227 | none; test code | unchanged behaviour | `TestAPartialBlockSaysTheInterlockRefusesIt` (this function is the test) |
| B2 | if at line 228 | none; test code | unchanged behaviour | `TestAPartialBlockSaysTheInterlockRefusesIt` (this function is the test) |
