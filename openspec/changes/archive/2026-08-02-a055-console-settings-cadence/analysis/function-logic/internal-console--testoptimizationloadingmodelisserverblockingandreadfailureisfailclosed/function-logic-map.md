# Function Logic Map: `TestOptimizationLoadingModelIsServerBlockingAndReadFailureIsFailClosed`
...
|---|---|---|---|---|
| B1 | range at line 225 | none; test code | unchanged behaviour | `TestOptimizationLoadingModelIsServerBlockingAndReadFailureIsFailClosed` (this function is the test) |
| B2 | if at line 226 | none; test code | unchanged behaviour | `TestOptimizationLoadingModelIsServerBlockingAndReadFailureIsFailClosed` (this function is the test) |
| B3 | if at line 230 | none; test code | unchanged behaviour | `TestOptimizationLoadingModelIsServerBlockingAndReadFailureIsFailClosed` (this function is the test) |
