# Function Logic Map: `TestSettingsRendersSignedReleaseActionWithoutFetching`

- Source: `internal/console/signed_release_test.go`
...
|---|---|---|---|---|
| B1 | range at line 32 | none; test code | unchanged behaviour | `TestSettingsRendersSignedReleaseActionWithoutFetching` (this function is the test) |
| B2 | if at line 37 | none; test code | unchanged behaviour | `TestSettingsRendersSignedReleaseActionWithoutFetching` (this function is the test) |
| B3 | if at line 41 | none; test code | unchanged behaviour | `TestSettingsRendersSignedReleaseActionWithoutFetching` (this function is the test) |
