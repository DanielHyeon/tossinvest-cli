# Function Logic Map: `TestRejectedEnvironmentCredentialsStayOffTheSetupScreen`

- Source: `internal/console/openapi_onboarding_test.go`
...
|---|---|---|---|---|
| B1 | if at line 220 | none; test code | unchanged behaviour | `TestRejectedEnvironmentCredentialsStayOffTheSetupScreen` (this function is the test) |
| B2 | if at line 223 | none; test code | unchanged behaviour | `TestRejectedEnvironmentCredentialsStayOffTheSetupScreen` (this function is the test) |
| B3 | if at line 226 | none; test code | unchanged behaviour | `TestRejectedEnvironmentCredentialsStayOffTheSetupScreen` (this function is the test) |
