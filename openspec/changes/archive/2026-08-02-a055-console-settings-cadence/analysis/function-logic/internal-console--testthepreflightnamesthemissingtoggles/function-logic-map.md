# Function Logic Map: `TestThePreflightNamesTheMissingToggles`
...
|---|---|---|---|---|
| B1 | range at line 231 | none; test code | unchanged behaviour | `TestThePreflightNamesTheMissingToggles` (this function is the test) |
| B2 | if at line 232 | none; test code | unchanged behaviour | `TestThePreflightNamesTheMissingToggles` (this function is the test) |
