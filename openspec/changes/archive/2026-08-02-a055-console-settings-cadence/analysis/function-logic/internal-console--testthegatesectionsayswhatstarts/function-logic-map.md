...
|---|---|---|---|---|
| B1 | range at line 263 | none; test code | unchanged behaviour | `TestTheGateSectionSaysWhatStarts` (this function is the test) |
| B2 | if at line 271 | none; test code | unchanged behaviour | `TestTheGateSectionSaysWhatStarts` (this function is the test) |
