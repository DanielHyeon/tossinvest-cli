# Function Logic Map: `TestRemoteSettingsCSPRemainsScriptFree`

- Source: `internal/console/remote_csp_test.go`
...
|---|---|---|---|---|
| B1 | if at line 18 | none; test code | unchanged behaviour | `TestRemoteSettingsCSPRemainsScriptFree` (this function is the test) |
| B2 | if at line 22 | none; test code | unchanged behaviour | `TestRemoteSettingsCSPRemainsScriptFree` (this function is the test) |
| B3 | range at line 26 | none; test code | unchanged behaviour | `TestRemoteSettingsCSPRemainsScriptFree` (this function is the test) |
| B4 | if at line 27 | none; test code | unchanged behaviour | `TestRemoteSettingsCSPRemainsScriptFree` (this function is the test) |
| B5 | range at line 31 | none; test code | unchanged behaviour | `TestRemoteSettingsCSPRemainsScriptFree` (this function is the test) |
| B6 | if at line 32 | none; test code | unchanged behaviour | `TestRemoteSettingsCSPRemainsScriptFree` (this function is the test) |
