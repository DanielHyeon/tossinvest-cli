# Function Logic Map: `TestWithoutASeamTheLimitEditorRefusesRatherThanPretends`
...
|---|---|---|---|---|
| B1 | if at line 520 | none; test code | unchanged behaviour | `TestWithoutASeamTheLimitEditorRefusesRatherThanPretends` (this function is the test) |
| B2 | range at line 523 | none; test code | unchanged behaviour | `TestWithoutASeamTheLimitEditorRefusesRatherThanPretends` (this function is the test) |
| B3 | if at line 525 | none; test code | unchanged behaviour | `TestWithoutASeamTheLimitEditorRefusesRatherThanPretends` (this function is the test) |
