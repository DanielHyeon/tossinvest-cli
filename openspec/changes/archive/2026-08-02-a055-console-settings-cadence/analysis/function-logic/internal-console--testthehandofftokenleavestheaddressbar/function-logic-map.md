# Function Logic Map: `TestTheHandoffTokenLeavesTheAddressBar`
...
|---|---|---|---|---|
| B1 | if at line 391 | none; test code | unchanged behaviour | `TestTheHandoffTokenLeavesTheAddressBar` (this function is the test) |
| B2 | if at line 395 | none; test code | unchanged behaviour | `TestTheHandoffTokenLeavesTheAddressBar` (this function is the test) |
| B3 | if at line 398 | none; test code | unchanged behaviour | `TestTheHandoffTokenLeavesTheAddressBar` (this function is the test) |
