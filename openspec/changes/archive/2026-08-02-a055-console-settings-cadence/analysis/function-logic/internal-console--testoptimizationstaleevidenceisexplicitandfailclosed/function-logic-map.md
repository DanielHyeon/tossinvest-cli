...
|---|---|---|---|---|
| B1 | range at line 193 | none; test code | unchanged behaviour | `TestOptimizationStaleEvidenceIsExplicitAndFailClosed` (this function is the test) |
| B2 | if at line 194 | none; test code | unchanged behaviour | `TestOptimizationStaleEvidenceIsExplicitAndFailClosed` (this function is the test) |
