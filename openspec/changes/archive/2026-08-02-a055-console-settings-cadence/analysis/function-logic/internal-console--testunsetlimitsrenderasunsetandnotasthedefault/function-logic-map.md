# Function Logic Map: `TestUnsetLimitsRenderAsUnsetAndNotAsTheDefault`
...
|---|---|---|---|---|
| B1 | if at line 207 | none; test code | unchanged behaviour | `TestUnsetLimitsRenderAsUnsetAndNotAsTheDefault` (this function is the test) |
| B2 | range at line 210 | none; test code | unchanged behaviour | `TestUnsetLimitsRenderAsUnsetAndNotAsTheDefault` (this function is the test) |
| B3 | if at line 211 | none; test code | unchanged behaviour | `TestUnsetLimitsRenderAsUnsetAndNotAsTheDefault` (this function is the test) |
