# Function Logic Map: `TestThePreflightRendersWhatItCannotJudge`
...
|---|---|---|---|---|
| B1 | if at line 218 | none; test code | unchanged behaviour | `TestThePreflightRendersWhatItCannotJudge` (this function is the test) |
| B2 | if at line 221 | none; test code | unchanged behaviour | `TestThePreflightRendersWhatItCannotJudge` (this function is the test) |
