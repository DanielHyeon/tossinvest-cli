...
|---|---|---|---|---|
| B1 | primary dark media missing | `TestTradingViewsDarkSemanticStatusColorsMeetWCAGAA` | not observed; the primary dark boundary predates a043 | defensive fatal guard, current fixture false |
| B2 | dark/mobile closing boundary missing | same test | not observed; the dark/mobile boundary predates a043 | defensive fatal guard, current fixture false |
