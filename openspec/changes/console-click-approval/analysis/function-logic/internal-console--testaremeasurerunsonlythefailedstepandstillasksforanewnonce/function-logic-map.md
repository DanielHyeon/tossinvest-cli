# Function Logic Map: `TestARemeasureRunsOnlyTheFailedStepAndStillAsksForANewNonce`
...
| B2 | `if view.Batch == nil \|\| strings.TrimSpace(view.Batch.Nonce) == "" {` (internal/console/remeasure_test.go:142, if) | 아래 State mutations 참조 | 조건 불충족 시 조기 반환 또는 분기 | 이 함수 자체가 테스트다 |
