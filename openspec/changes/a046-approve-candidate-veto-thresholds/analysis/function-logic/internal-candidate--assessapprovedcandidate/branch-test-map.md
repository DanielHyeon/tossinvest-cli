...
| B6 | all three measured-clear vetoes return an immutable approved value with exact threshold provenance and deterministic candidate-life ID | `TestAssessApprovedCandidateReturnsPassWithImmutableProvenance` | compile RED: immutable accessors and full provenance absent | focused GREEN |
