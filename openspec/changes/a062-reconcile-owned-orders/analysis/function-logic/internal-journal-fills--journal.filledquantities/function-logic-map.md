...
- Inputs are `Journal.FilledQuantities(params=1, results=2)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/fills.go:1412 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | for | internal/journal/fills.go:1418 | Preserve the condition, error propagation, and fail-closed behavior. |
| B3 | if | internal/journal/fills.go:1420 | Preserve the condition, error propagation, and fail-closed behavior. |
| B4 | if | internal/journal/fills.go:1424 | Preserve the condition, error propagation, and fail-closed behavior. |
| B5 | if | internal/journal/fills.go:1429 | Preserve the condition, error propagation, and fail-closed behavior. |
| B6 | range | internal/journal/fills.go:1433 | Preserve the condition, error propagation, and fail-closed behavior. |
...
- AST assignment points: 8; return points: 4; deferred operations: 1.
