...
- Inputs are `TestStartupSweepsExpiredUnconsumedReservationsBeforeTrading(params=1, results=0)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/app/engine/engine_test.go:474 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | if | internal/app/engine/engine_test.go:478 | Preserve the condition, error propagation, and fail-closed behavior. |
| B3 | if | internal/app/engine/engine_test.go:481 | Preserve the condition, error propagation, and fail-closed behavior. |
