# Function Logic Map: `TestPreOwnerTerminalEvidenceCannotReleaseAFutureReservation`

Source: `internal/journal/reservation_sweep_test.go`
Function: `TestPreOwnerTerminalEvidenceCannotReleaseAFutureReservation`
Signature: `TestPreOwnerTerminalEvidenceCannotReleaseAFutureReservation(params=1, results=0)`
Source SHA-256: `dcfcc7de8f1e832e67d19949578ce40bf3d79d549ad6f99de6f5a714cfcd011e`
Revision: `current`

## Inputs and invariants

- Inputs are `TestPreOwnerTerminalEvidenceCannotReleaseAFutureReservation(params=1, results=0)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/reservation_sweep_test.go:252 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | if | internal/journal/reservation_sweep_test.go:255 | Preserve the condition, error propagation, and fail-closed behavior. |
