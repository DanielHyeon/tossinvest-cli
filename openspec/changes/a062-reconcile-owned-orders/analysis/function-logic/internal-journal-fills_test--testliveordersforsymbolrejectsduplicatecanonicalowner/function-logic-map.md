# Function Logic Map: `TestLiveOrdersForSymbolRejectsDuplicateCanonicalOwner`

Source: `internal/journal/fills_test.go`
Function: `TestLiveOrdersForSymbolRejectsDuplicateCanonicalOwner`
Signature: `TestLiveOrdersForSymbolRejectsDuplicateCanonicalOwner(params=1, results=0)`
Source SHA-256: `5da6390852646dcea50c6546b6f28e0c82f15f832d8953cb57aad12da363499a`
Revision: `current`

## Inputs and invariants

- Inputs are `TestLiveOrdersForSymbolRejectsDuplicateCanonicalOwner(params=1, results=0)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/fills_test.go:1486 | Preserve the condition, error propagation, and fail-closed behavior. |
