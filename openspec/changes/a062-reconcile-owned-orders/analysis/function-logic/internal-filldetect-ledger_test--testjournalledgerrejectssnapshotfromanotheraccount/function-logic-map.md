...
- Inputs are `TestJournalLedgerRejectsSnapshotFromAnotherAccount(params=1, results=0)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/filldetect/ledger_test.go:352 | Preserve the condition, error propagation, and fail-closed behavior. |
...
- `ledger.Apply`: errors and state follow mapped branches.
