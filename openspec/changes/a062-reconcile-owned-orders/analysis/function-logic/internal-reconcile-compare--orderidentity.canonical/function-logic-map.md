# Function Logic Map: `OrderIdentity.canonical`

Source: `internal/reconcile/compare.go`
Function: `OrderIdentity.canonical`
Signature: `OrderIdentity.canonical(params=0, results=1)`
Source SHA-256: `36ce21d173549fe4b957c6132a56993887fb62dfe3acaa7c9afd39a6e61154b2`
Revision: `current`

## Inputs and invariants

- Inputs are `OrderIdentity.canonical(params=0, results=1)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | happy path | internal/reconcile/compare.go:70 | Preserve the source-bound happy path and propagated errors. |
