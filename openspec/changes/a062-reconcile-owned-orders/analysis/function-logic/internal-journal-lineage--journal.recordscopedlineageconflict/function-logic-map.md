...
- Inputs are `Journal.recordScopedLineageConflict(params=4, results=1)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/lineage.go:455 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | if | internal/journal/lineage.go:458 | Preserve the condition, error propagation, and fail-closed behavior. |
