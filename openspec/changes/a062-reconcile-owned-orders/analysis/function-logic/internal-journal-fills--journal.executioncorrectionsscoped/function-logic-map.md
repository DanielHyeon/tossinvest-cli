# Function Logic Map: `Journal.ExecutionCorrectionsScoped`

Source: `internal/journal/fills.go`
Function: `Journal.ExecutionCorrectionsScoped`
Signature: `Journal.ExecutionCorrectionsScoped(params=2, results=2)`
Source SHA-256: `000918b94c8c3f776b611421c412e4604086fc4cbee2fd0e7c21fe0dd46454c0`
Revision: `current`

## Inputs and invariants

- Inputs are `Journal.ExecutionCorrectionsScoped(params=2, results=2)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | if | internal/journal/fills.go:1313 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | if | internal/journal/fills.go:1336 | Preserve the condition, error propagation, and fail-closed behavior. |
