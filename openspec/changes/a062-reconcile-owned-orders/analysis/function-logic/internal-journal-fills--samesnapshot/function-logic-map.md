...
- Inputs are `sameSnapshot(params=2, results=1)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | happy path | internal/journal/fills.go:840 | Preserve the source-bound happy path and propagated errors. |
