...
- Inputs are `blocksFor(params=3, results=1)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | range | internal/reconcile/mismatch.go:834 | Preserve the condition, error propagation, and fail-closed behavior. |
| B2 | range | internal/reconcile/mismatch.go:848 | Preserve the condition, error propagation, and fail-closed behavior. |
