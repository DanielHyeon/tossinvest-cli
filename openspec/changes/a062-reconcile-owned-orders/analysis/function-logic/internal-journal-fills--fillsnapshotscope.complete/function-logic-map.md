...
- Inputs are `FillSnapshotScope.complete(params=0, results=1)` parameters and receiver or package state.
...
| --- | --- | --- | --- |
| B1 | happy path | internal/journal/fills.go:240 | Preserve the source-bound happy path and propagated errors. |
