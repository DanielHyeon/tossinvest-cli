...
a074는 그 순서를 유지한다. 함수 주석이 명시한다 — "alertRefused may synchronously
...
| `go build ./...` | OK |
| `go vet ./...` | clean |
| `go test ./... -count=1` | **6136 passed / 79 packages** (a074 이전 6095, 신규 41) |
...
| 항목 | 값 |
|---|---|
| 원래 base | `0c563c6cca3f636a680fc1b76ae440f9eee7706d` |
| 재기준화된 base | `6b47be2ff8ebd21a59dec682183e015cec8584da` (병합 커밋) |

**재기준화 전에 원래 base로 검사를 다시 돌렸다.** `0c563c6cca3f` 커밋을 detached
