# Function Logic Map: `TestTheAdvancedFormIsInsideAFold`
...
|---|---|---|---|---|
| B1 | if at line 347 | none; test code | unchanged behaviour | `TestTheAdvancedFormIsInsideAFold` (this function is the test) |
| B2 | if at line 351 | none; test code | unchanged behaviour | `TestTheAdvancedFormIsInsideAFold` (this function is the test) |
| B3 | if at line 354 | none; test code | unchanged behaviour | `TestTheAdvancedFormIsInsideAFold` (this function is the test) |
