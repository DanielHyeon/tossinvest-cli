# Function Logic Map: `TestAnUnwiredSettingsSeamIsExplained`
...
|---|---|---|---|---|
| B1 | if at line 119 | none; test code | unchanged behaviour | `TestAnUnwiredSettingsSeamIsExplained` (this function is the test) |
