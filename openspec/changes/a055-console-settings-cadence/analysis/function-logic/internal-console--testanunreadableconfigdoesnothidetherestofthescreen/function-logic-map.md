# Function Logic Map: `TestAnUnreadableConfigDoesNotHideTheRestOfTheScreen`
...
|---|---|---|---|---|
| B1 | if at line 537 | none; test code | unchanged behaviour | `TestAnUnreadableConfigDoesNotHideTheRestOfTheScreen` (this function is the test) |
| B2 | if at line 542 | none; test code | unchanged behaviour | `TestAnUnreadableConfigDoesNotHideTheRestOfTheScreen` (this function is the test) |
