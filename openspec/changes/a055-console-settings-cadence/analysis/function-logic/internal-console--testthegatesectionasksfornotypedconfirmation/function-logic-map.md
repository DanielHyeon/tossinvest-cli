# Function Logic Map: `TestTheGateSectionAsksForNoTypedConfirmation`
...
|---|---|---|---|---|
| B1 | range at line 285 | none; test code | unchanged behaviour | `TestTheGateSectionAsksForNoTypedConfirmation` (this function is the test) |
| B2 | if at line 286 | none; test code | unchanged behaviour | `TestTheGateSectionAsksForNoTypedConfirmation` (this function is the test) |
| B3 | if at line 291 | none; test code | unchanged behaviour | `TestTheGateSectionAsksForNoTypedConfirmation` (this function is the test) |
