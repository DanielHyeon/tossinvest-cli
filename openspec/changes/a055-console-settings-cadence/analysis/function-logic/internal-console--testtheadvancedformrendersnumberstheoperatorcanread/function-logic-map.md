# Function Logic Map: `TestTheAdvancedFormRendersNumbersTheOperatorCanRead`
...
|---|---|---|---|---|
| B1 | if at line 397 | none; test code | unchanged behaviour | `TestTheAdvancedFormRendersNumbersTheOperatorCanRead` (this function is the test) |
| B2 | if at line 400 | none; test code | unchanged behaviour | `TestTheAdvancedFormRendersNumbersTheOperatorCanRead` (this function is the test) |
