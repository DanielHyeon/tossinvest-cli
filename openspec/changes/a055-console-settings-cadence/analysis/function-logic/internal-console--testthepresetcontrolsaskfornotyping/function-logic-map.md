# Function Logic Map: `TestThePresetControlsAskForNoTyping`
...
|---|---|---|---|---|
| B1 | if at line 137 | none; test code | unchanged behaviour | `TestThePresetControlsAskForNoTyping` (this function is the test) |
| B2 | if at line 141 | none; test code | unchanged behaviour | `TestThePresetControlsAskForNoTyping` (this function is the test) |
| B3 | range at line 145 | none; test code | unchanged behaviour | `TestThePresetControlsAskForNoTyping` (this function is the test) |
| B4 | if at line 146 | none; test code | unchanged behaviour | `TestThePresetControlsAskForNoTyping` (this function is the test) |
| B5 | if at line 157 | none; test code | unchanged behaviour | `TestThePresetControlsAskForNoTyping` (this function is the test) |
| B6 | if at line 161 | none; test code | unchanged behaviour | `TestThePresetControlsAskForNoTyping` (this function is the test) |
| B7 | if at line 165 | none; test code | unchanged behaviour | `TestThePresetControlsAskForNoTyping` (this function is the test) |
