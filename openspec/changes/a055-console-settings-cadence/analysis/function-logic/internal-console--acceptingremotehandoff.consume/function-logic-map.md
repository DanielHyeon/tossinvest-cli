# Function Logic Map: `acceptingRemoteHandoff.Consume`
...
|---|---|---|---|---|
| B1 | if at line 51 | none; test code | unchanged behaviour | `acceptingRemoteHandoff.Consume` (this function is the test) |
