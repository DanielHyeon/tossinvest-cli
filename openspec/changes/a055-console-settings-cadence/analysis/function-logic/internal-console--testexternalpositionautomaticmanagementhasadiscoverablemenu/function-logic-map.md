...
|---|---|---|---|---|
| B1 | range at line 76 | none; test code | unchanged behaviour | `TestExternalPositionAutomaticManagementHasADiscoverableMenu` (this function is the test) |
| B2 | if at line 87 | none; test code | unchanged behaviour | `TestExternalPositionAutomaticManagementHasADiscoverableMenu` (this function is the test) |
