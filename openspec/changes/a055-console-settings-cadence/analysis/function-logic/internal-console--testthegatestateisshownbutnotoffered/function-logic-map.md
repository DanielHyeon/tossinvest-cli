# Function Logic Map: `TestTheGateStateIsShownButNotOffered`
...
|---|---|---|---|---|
| B1 | if at line 554 | none; test code | unchanged behaviour | `TestTheGateStateIsShownButNotOffered` (this function is the test) |
| B2 | range at line 557 | none; test code | unchanged behaviour | `TestTheGateStateIsShownButNotOffered` (this function is the test) |
| B3 | if at line 558 | none; test code | unchanged behaviour | `TestTheGateStateIsShownButNotOffered` (this function is the test) |
