# Function Logic Map: `TestAutostartScreenRendersStateAndMeaning`
...
|---|---|---|---|---|
| B1 | range at line 43 | none; test code | unchanged behaviour | `TestAutostartScreenRendersStateAndMeaning` (this function is the test) |
| B2 | if at line 51 | none; test code | unchanged behaviour | `TestAutostartScreenRendersStateAndMeaning` (this function is the test) |
