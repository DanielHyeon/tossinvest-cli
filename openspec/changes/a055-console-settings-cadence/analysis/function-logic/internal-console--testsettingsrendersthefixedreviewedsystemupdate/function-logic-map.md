# Function Logic Map: `TestSettingsRendersTheFixedReviewedSystemUpdate`

- Source: `internal/console/system_update_test.go`
...
|---|---|---|---|---|
| B1 | range at line 152 | none; test code | unchanged behaviour | `TestSettingsRendersTheFixedReviewedSystemUpdate` (this function is the test) |
| B2 | if at line 160 | none; test code | unchanged behaviour | `TestSettingsRendersTheFixedReviewedSystemUpdate` (this function is the test) |
| B3 | if at line 164 | none; test code | unchanged behaviour | `TestSettingsRendersTheFixedReviewedSystemUpdate` (this function is the test) |
