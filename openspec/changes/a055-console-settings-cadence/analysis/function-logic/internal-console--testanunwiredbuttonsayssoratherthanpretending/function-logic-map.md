# Function Logic Map: `TestAnUnwiredButtonSaysSoRatherThanPretending`
...
|---|---|---|---|---|
| B1 | if at line 334 | none; test code | unchanged behaviour | `TestAnUnwiredButtonSaysSoRatherThanPretending` (this function is the test) |
| B2 | if at line 338 | none; test code | unchanged behaviour | `TestAnUnwiredButtonSaysSoRatherThanPretending` (this function is the test) |
