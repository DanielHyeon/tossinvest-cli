# Function Logic Map: `TestTheScreenNamesTheMatchingTier`
...
|---|---|---|---|---|
| B1 | if at line 244 | none; test code | unchanged behaviour | `TestTheScreenNamesTheMatchingTier` (this function is the test) |
| B2 | if at line 249 | none; test code | unchanged behaviour | `TestTheScreenNamesTheMatchingTier` (this function is the test) |
