...
|---|---|---|---|---|
| B1 | range at line 261 | none; test code | unchanged behaviour | `TestTheStopFractionIsASlider` (this function is the test) |
| B2 | range at line 277 | none; test code | unchanged behaviour | `TestTheStopFractionIsASlider` (this function is the test) |
| B3 | if at line 281 | none; test code | unchanged behaviour | `TestTheStopFractionIsASlider` (this function is the test) |
| B4 | range at line 285 | none; test code | unchanged behaviour | `TestTheStopFractionIsASlider` (this function is the test) |
| B5 | if at line 286 | none; test code | unchanged behaviour | `TestTheStopFractionIsASlider` (this function is the test) |
| B6 | if at line 290 | none; test code | unchanged behaviour | `TestTheStopFractionIsASlider` (this function is the test) |
