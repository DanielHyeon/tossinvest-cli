# Function Logic Map: `TestAutostartUnwiredAndLoadErrorAreExplicit`

- Source: `internal/console/settings_autostart_test.go`
...
|---|---|---|---|---|
| B1 | if at line 187 | none; test code | unchanged behaviour | `TestAutostartUnwiredAndLoadErrorAreExplicit` (this function is the test) |
| B2 | if at line 190 | none; test code | unchanged behaviour | `TestAutostartUnwiredAndLoadErrorAreExplicit` (this function is the test) |
| B3 | if at line 200 | none; test code | unchanged behaviour | `TestAutostartUnwiredAndLoadErrorAreExplicit` (this function is the test) |
