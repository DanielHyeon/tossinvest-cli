# Function Logic Map: `TestTheSettingsScreenShowsTheRawBlockAndTheVerdict`
...
|---|---|---|---|---|
| B1 | range at line 105 | none; test code | unchanged behaviour | `TestTheSettingsScreenShowsTheRawBlockAndTheVerdict` (this function is the test) |
| B2 | if at line 110 | none; test code | unchanged behaviour | `TestTheSettingsScreenShowsTheRawBlockAndTheVerdict` (this function is the test) |
