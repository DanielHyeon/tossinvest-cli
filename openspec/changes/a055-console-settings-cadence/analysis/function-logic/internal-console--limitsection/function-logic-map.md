# Function Logic Map: `limitSection`
...
|---|---|---|---|---|
| B1 | if at line 570 | none; test code | unchanged behaviour | `limitSection` (this function is the test) |
| B2 | if at line 574 | none; test code | unchanged behaviour | `limitSection` (this function is the test) |
