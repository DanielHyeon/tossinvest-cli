# Function Logic Map: `TestRemoteSessionExpiresAndLogoutRevokesIt`
...
|---|---|---|---|---|
| B1 | if at line 348 | none; test code | unchanged behaviour | `TestRemoteSessionExpiresAndLogoutRevokesIt` (this function is the test) |
| B2 | if at line 357 | none; test code | unchanged behaviour | `TestRemoteSessionExpiresAndLogoutRevokesIt` (this function is the test) |
| B3 | if at line 362 | none; test code | unchanged behaviour | `TestRemoteSessionExpiresAndLogoutRevokesIt` (this function is the test) |
