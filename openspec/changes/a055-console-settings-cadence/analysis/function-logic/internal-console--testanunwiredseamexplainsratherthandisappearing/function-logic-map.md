# Function Logic Map: `TestAnUnwiredSeamExplainsRatherThanDisappearing`
...
|---|---|---|---|---|
| B1 | if at line 306 | none; test code | unchanged behaviour | `TestAnUnwiredSeamExplainsRatherThanDisappearing` (this function is the test) |
| B2 | if at line 310 | none; test code | unchanged behaviour | `TestAnUnwiredSeamExplainsRatherThanDisappearing` (this function is the test) |
| B3 | if at line 313 | none; test code | unchanged behaviour | `TestAnUnwiredSeamExplainsRatherThanDisappearing` (this function is the test) |
