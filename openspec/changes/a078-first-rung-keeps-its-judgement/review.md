...
```text
- change id / task id: a078-first-rung-keeps-its-judgement / 5.1
...
2. 격리 생성 미로깅(I2)과 알림 미전달(I3)은 a078 범위 밖이며 별도 change가 필요하다.
...
- `go test ./...` — 78 패키지 **6050건 green** (a077 8건 + a078 11건 포함).
