...
Change under review (read ALL of it first; the design is revision 5, third printing (5판 3쇄)):
...
- openspec/changes/a124-a-deliverer-that-keeps-failing-blocks-entry/review.md sections §0, §0.2, §0.3, §0.4, §0.5 and §0.6 (findings F1–F13, N1–N8, R1–R8, Q1–Q7, V1–V6, W1–W5 and
...
1. For each earlier finding F1–F13, N1–N8, R1–R8, Q1–Q7, V1–V6 and W1–W5: RESOLVED / PARTIAL / NOT RESOLVED, one line why.
2. New findings table: id | severity (P0 = unsafe or unimplementable as written, P1 = must fix before freeze, P2 = should
   ...
   before a judgement is dropped (ACKNOWLEDGED only), the bounded retry and the deferral to the next cycle; the listing-counter fence; the (P1)–(P3) argument; the case table; whether the
