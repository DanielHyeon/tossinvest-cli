...
Change under review (read ALL of it first; the design is revision 5):
...
- openspec/changes/a124-a-deliverer-that-keeps-failing-blocks-entry/review.md sections §0, §0.2, §0.3 and §0.4 (findings F1–F13, N1–N8, R1–R8, Q1–Q7 and
...
1. For each earlier finding F1–F13, N1–N8, R1–R8 and Q1–Q7: RESOLVED / PARTIAL / NOT RESOLVED, one line why.
2. New findings table: id | severity (P0 = unsafe or unimplementable as written, P1 = must fix before freeze, P2 = should
   ...
   special attention to the EntryGate per-reason clear epoch in D7 (the proof labelled (P); the case table; whether the
