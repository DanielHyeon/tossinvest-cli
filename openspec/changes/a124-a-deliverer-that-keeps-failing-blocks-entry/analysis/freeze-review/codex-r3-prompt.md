...
Change under review (read ALL of it first; the design is revision 3):
...
- openspec/changes/a124-a-deliverer-that-keeps-failing-blocks-entry/review.md sections §0 and §0.2 (findings F1–F13 and N1–N8 and
...
1. For each earlier finding F1–F13 and N1–N8: RESOLVED / PARTIAL / NOT RESOLVED, one line why.
