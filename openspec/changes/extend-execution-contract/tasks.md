...
- [ ] 7.2 [T][High-risk] journal 편입: 엔진 프로필이 journal open — 파일시스템 allowlist·무결성 검사가 기동 조건이 됨을 문서화, config-dir 격리 보존, tmpfs 테스트는 격리 경로. 기동 시 `PruneSpentNonces` 1회 수행(보존 불변식 내)
