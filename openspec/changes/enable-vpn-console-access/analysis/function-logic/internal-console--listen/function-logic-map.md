# Function Logic Map: `Listen`

- Source: `internal/console/console.go`
- AST evidence: `ast.json` (`80954bc227bda6f63d376836c22b272a60efa5e3647689c8d0a490dc4663e09c`)
...
|---|---|---|---|---|
| B1 | existing if branch at line 419 | only the branch's documented state transition | existing return/error contract | `TestListen` |
