...
> **정정 (2026-09-14, task 7.2.2).** 이 다섯은 결국 **답할 수 있는 질문도 얻지 못한다.**
> 착지가 base 와 같은 소스를 가진 자리이면 증거는 "작업이 base 앞에 있다"와 "번들을 갱신하지
> 않은 채 작업이 착지 뒤에 있다"(§6 리뷰 V1)를 가르지 못하고, 사람이 둘째를 막기로 골랐다 —
> 착지는 고정 소스 중 하나 이상이 base 와 달라야 한다. 대가로 a074 · a077 · a079(와 a075 ·
> a078 · a091 · a092 · a094)는 착지를 얻지 못하고 넓은 창으로 돌아간다. 위 문단은 그 결정 전의
> 설계로 남겨 둔다. 기록은 tasks.md 7.2.2 · review.md `## DECIDE — task 7.2.2`.
