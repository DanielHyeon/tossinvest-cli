# Branch Test Map: `_base_shaped_bundles` (Python, a122 task 7.5.2)
...
|---|---|---|
| base 를 한 프로세스로 | W21 | `test_the_base_shape_advice_reads_the_base_once` |
...
| 갈래 | 변이 (`75_mut.py`) | 잡는 시험 |
|---|---|---|
| base 모양 조언도 한 번 읽는다 | W21 | `test_the_base_shape_advice_reads_the_base_once` |
