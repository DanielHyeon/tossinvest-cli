# Branch Test Map: `_why` (Python, a122 task 7.5.2.3)
...
|---|---|---|
| 실패를 사람의 말로 | AA14 · AA15 | `test_a_fifo_in_place_of_the_review_file_is_named_not_waited_on` · `test_a_fifo_in_place_of_the_base_commit_is_named_not_waited_on` |
