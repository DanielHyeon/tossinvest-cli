# Branch Test Map: `go_inputs` (Python, `execution_baseline.py`)
...
|---|---|---|
| `timeout=` | EB3 | `test_every_child_process_in_the_gate_modules_names_a_timeout`(구조) **하나뿐** — 행동 시험(`…verdict_starts…`)의 픽스처는 이관 경로를 안 탄다 |
