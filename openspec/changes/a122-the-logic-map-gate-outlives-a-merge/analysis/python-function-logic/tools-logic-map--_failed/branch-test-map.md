# Branch Test Map: `_failed` (Python, a122 task 7.5.2.3)
...
|---|---|---|
| 실패의 지문은 종류 + errno | AA1 | `test_a_failed_read_is_remembered_so_the_file_coming_back_is_seen` |
