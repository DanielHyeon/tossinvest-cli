# Branch Test Map: `_file_outcome` (Python, a122 task 7.5.2.3)
...
|---|---|---|
| 실패도 지문이 된다 | AA1 | `test_a_failed_read_is_remembered_so_the_file_coming_back_is_seen` · `test_a_bundle_whose_read_fails_once_is_never_judged_absent` |
