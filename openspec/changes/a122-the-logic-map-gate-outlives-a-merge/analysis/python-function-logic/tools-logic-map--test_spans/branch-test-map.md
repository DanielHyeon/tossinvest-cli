# Branch Test Map: `test_spans` (Python, a122 task 7.5.2.3)
...
|---|---|---|
| 시험 파일도 깔때기로 | AA3 | `test_a_test_file_that_appears_after_the_index_was_built_asks_for_a_rerun`(색인 집합) · FIFO 는 `_opened_bytes` 가 막는다(Z1) |
