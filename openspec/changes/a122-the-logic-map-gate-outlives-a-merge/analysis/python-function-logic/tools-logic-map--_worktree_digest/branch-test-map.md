# Branch Test Map: `_worktree_digest` (Python, a122 task 7.5.2.3)
...
|---|---|---|
| 워킹트리 소스도 깔때기로 | W21 | `test_the_base_shape_advice_reads_the_base_once` · `test_a_pinned_source_rewritten_after_it_was_judged_asks_for_a_rerun` |
