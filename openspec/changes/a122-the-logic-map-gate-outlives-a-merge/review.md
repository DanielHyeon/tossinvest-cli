...
| a079 | `448dfeb1` | ∅ | **통과** |
| a075 | `448dfeb1` | ∅ | **통과** |
| a076 | `448dfeb1` (번들 없음, 면제 표식) | ∅ | **통과** |
| a077 | `6b47be2f` — **base 보다 앞** | 역방향 | **거절** |

a077 이 거절되는 것이 옳다. 2026-08-04 재기준화가 base 를 `448dfeb1` 로 옮기면서
a077 의 번들만 다시 안 뽑았다 — 증거가 자기 base 보다 낡았다. 그것은 a077 의 결함이고
a122 가 덮을 것이 아니다.
