...
- [ ] 7.2.5 **H3 — 섞인 V1 을 막을지 사람이 정한다 (7.2.2 가 연 것).** FLM 을 여럿 먼저 커밋하고 일부만 갱신한 뒤 나머지 파일을
...
- [ ] 7.2.6 **H4 — 착지 기록 뒤의 리뷰 수리가 고정 파일을 고치면 초록이다 (2026-09-16 실측, 사람 결정).** 7.2.5 · 6.6 의 추천을 쓰려고
