...
- Source: `internal/app/engine/adoption.go` (lines 441–472)
...
|---|---|---|---|---|
| B1 | (442) `if` — if d.grown[p.ID] | 본문 참조 | — | 아래 Branch Test Map |
| B2 | (446) `if` — if err != nil | 본문 참조 | — | 아래 Branch Test Map |
| B3 | (450) `if` — if err != nil || cmp <= 0 | 본문 참조 | — | 아래 Branch Test Map |
