...
- Source: `internal/app/engine/exitloop.go` (lines 1495–1512)
...
|---|---|---|---|
| `o.alert` | (1500) o.alert(ctx, obs.Event{ | 호출부 계약 유지 | AST `calls` |
| `o.label` | (1503) Title: o.label(p.Symbol) + " 보유 중이지만 엔진이 관리하지 않는다", | 호출부 계약 유지 | AST `calls` |
