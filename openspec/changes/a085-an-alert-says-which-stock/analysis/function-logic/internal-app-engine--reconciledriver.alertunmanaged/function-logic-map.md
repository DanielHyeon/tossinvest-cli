...
- Source: `internal/app/engine/adoption.go` (lines 392–432)
...
|---|---|---|---|---|
| B1 | (393) `if` — if d.unmanaged[p.ID] | 본문 참조 | — | 아래 Branch Test Map |
| B2 | (404) `switch` — switch | 본문 참조 | — | 아래 Branch Test Map |
| B3 | (405) `case` — case d.opts.Adoption.Rejected != "": | 본문 참조 | — | 아래 Branch Test Map |
| B4 | (407) `case` — case d.opts.Adoption.Excludes(p.Symbol): | 본문 참조 | — | 아래 Branch Test Map |
| B5 | (409) `case` — case d.opts.Adoption.Enabled: | 본문 참조 | — | 아래 Branch Test Map |
| B6 | (412) `case` — case d.opts.Adoption.Included(p.Symbol): | 본문 참조 | — | 아래 Branch Test Map |
