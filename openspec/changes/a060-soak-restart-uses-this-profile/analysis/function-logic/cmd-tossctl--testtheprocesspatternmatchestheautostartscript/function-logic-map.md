# Function Logic Map: `TestTheProcessPatternMatchesTheAutostartScript`
...
|---|---|---|---|---|
| B1 | if at line 241 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheProcessPatternMatchesTheAutostartScript` (this function is the test) |
