# Function Logic Map: `TestTheSoakPatternMatchesWhatTheConsoleSpawns`
...
|---|---|---|---|---|
| B1 | if at line 297 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheSoakPatternMatchesWhatTheConsoleSpawns` (this function is the test) |
| B2 | range at line 300 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheSoakPatternMatchesWhatTheConsoleSpawns` (this function is the test) |
| B3 | if at line 312 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheSoakPatternMatchesWhatTheConsoleSpawns` (this function is the test) |
