# Function Logic Map: `TestTheRestartAsksAboutThisConsolesRecord`
...
|---|---|---|---|---|
| B1 | if at line 393 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheRestartAsksAboutThisConsolesRecord` (this function is the test) |
| B2 | if at line 396 | 없음 — 테스트 코드 | unchanged behaviour | `TestTheRestartAsksAboutThisConsolesRecord` (this function is the test) |
