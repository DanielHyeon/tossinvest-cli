# Function Logic Map: `TestOnlyThisRecordsSoakIsFound`
...
|---|---|---|---|---|
| B1 | if at line 352 | 없음 — 테스트 코드 | unchanged behaviour | `TestOnlyThisRecordsSoakIsFound` (this function is the test) |
