# Function Logic Map: `TestTokenGenerationFenceRunsAfterOldSoakExitBeforeSpawn`

- Source: `cmd/tossctl/soakproc_openapi_test.go`
...
|---|---|---|---|---|
| B1 | if at line 17 | 없음 — 테스트 코드 | unchanged behaviour | `TestTokenGenerationFenceRunsAfterOldSoakExitBeforeSpawn` (this function is the test) |
| B2 | if at line 23 | 없음 — 테스트 코드 | unchanged behaviour | `TestTokenGenerationFenceRunsAfterOldSoakExitBeforeSpawn` (this function is the test) |
| B3 | if at line 24 | 없음 — 테스트 코드 | unchanged behaviour | `TestTokenGenerationFenceRunsAfterOldSoakExitBeforeSpawn` (this function is the test) |
