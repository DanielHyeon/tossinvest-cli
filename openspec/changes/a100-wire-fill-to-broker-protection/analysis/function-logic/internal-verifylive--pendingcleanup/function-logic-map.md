# Function Logic Map: `PendingCleanup`

- Source: `internal/verifylive/cleanup.go:119-121`
- Qualified function: `PendingCleanup`
- Revision: `current`
...
|---|---|---|---|
| Inputs and durable state | Exact typed/current values | `internal/verifylive/cleanup.go` plus A100 tasks 0.2a.1–0.2a.9 | Reject or terminal HOLD; never infer evidence |
...
|---|---|---|---|---|
| B1 | Branchless path `internal/verifylive/cleanup.go:119-121` | Preserve return and mutation ordering | `TestM0TriggeredWithoutChildIDIsManualReconcileOnly` |

## Calls and live bindings

| Callee | Why called | Error/timeout/retry contract | Evidence |
|---|---|---|---|
| `withoutM0ManualReconcile` | Source dependency | Propagate errors; M0 critical gaps are irreversible | AST |
| `cleanupFrom` | Source dependency | Propagate errors; M0 critical gaps are irreversible | AST |
| `Settled` | Source dependency | Propagate errors; M0 critical gaps are irreversible | AST |
