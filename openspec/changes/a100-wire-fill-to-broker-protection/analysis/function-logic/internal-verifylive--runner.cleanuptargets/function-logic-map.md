# Function Logic Map: `Runner.cleanupTargets`

- Source: `internal/verifylive/cleanup.go:103-108`
- Qualified function: `Runner.cleanupTargets`
- Revision: `current`
...
|---|---|---|---|---|
| B1 | Branchless path `internal/verifylive/cleanup.go:103-108` | Preserve return and mutation ordering | `TestM0TriggeredWithoutChildIDIsManualReconcileOnly` |
