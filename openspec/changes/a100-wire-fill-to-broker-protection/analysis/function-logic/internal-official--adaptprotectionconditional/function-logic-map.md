# Function Logic Map: `adaptProtectionConditional`

- Source: `internal/official/protection_reads.go:49-58`
- Qualified function: `adaptProtectionConditional`
- Revision: `current`
...
|---|---|---|---|
| Inputs and durable state | Exact typed/current values | `internal/official/protection_reads.go` plus A100 tasks 0.2a.1–0.2a.9 | Reject or terminal HOLD; never infer evidence |
...
|---|---|---|---|---|
| B1 | Branchless path `internal/official/protection_reads.go:49-58` | Preserve return and mutation ordering | `TestAttemptObserverTraces401RefreshThenSuccessfulRetry` |

## Calls and live bindings

| Callee | Why called | Error/timeout/retry contract | Evidence |
|---|---|---|---|
| None | Leaf | No hidden retry | AST |
