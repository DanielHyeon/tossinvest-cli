...
- AST evidence: `ast.json` (extracted Wave 2A 2026-09-25 at HEAD `648df8ef`; 111–114, 0 branches, 1 call)
...
|---|---|---|---|---|
| B1 | branchless: delegates with the caller's scope and quantity `"10"` | whatever the delegate writes (a confirmed place attempt for the order) | none | every caller in `internal/journal` (19 call sites at HEAD) |
