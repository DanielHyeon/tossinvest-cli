...
passing." a065는 라우트 셋을 더하므로 하한도 셋 올린다.
...
- 아무것도 바꾸지 않는다. a065의 편집은 하한 상수 `27 → 30`과 그 이유를 적은 주석뿐이다.
- 하한은 실제 등록 수(49)보다 여전히 낮다 — a065 이전부터 그랬고, 이 change는 자기가 더한 만큼만 올려 격차를 넓히지 않는다 (issues I4).
