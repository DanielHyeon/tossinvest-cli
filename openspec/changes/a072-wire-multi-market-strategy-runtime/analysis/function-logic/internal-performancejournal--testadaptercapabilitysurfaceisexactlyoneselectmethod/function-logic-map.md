# Function Logic Map: `TestAdapterCapabilitySurfaceIsExactlyOneSelectMethod`

- Source: `internal/performancejournal/adapter_test.go`
- Qualified function: `TestAdapterCapabilitySurfaceIsExactlyOneSelectMethod`
...
|---|---|---|---|
| function inputs and fixture/runtime state | exact types and identities declared by the source revision | `internal/performancejournal/adapter_test.go` plus its direct callers/tests | return/error or test assertion; no value is silently repaired |
