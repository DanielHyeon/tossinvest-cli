# Function Logic Map: `rebindRiskBucket`

- Source: `internal/journal/risk_bucket_admission_test.go`
- Qualified function: `rebindRiskBucket`
...
|---|---|---|---|
| function inputs and fixture/runtime state | exact types and identities declared by the source revision | `internal/journal/risk_bucket_admission_test.go` plus its direct callers/tests | return/error or test assertion; no value is silently repaired |
