# Function Logic Map: `TestCampaignCoreHasNoProductionBrokerOrToggleWiring`

- Source: `internal/journal/position_campaign_hardening_test.go`
- Qualified function: `TestCampaignCoreHasNoProductionBrokerOrToggleWiring`
...
|---|---|---|---|
| function inputs and fixture/runtime state | exact types and identities declared by the source revision | `internal/journal/position_campaign_hardening_test.go` plus its direct callers/tests | return/error or test assertion; no value is silently repaired |
