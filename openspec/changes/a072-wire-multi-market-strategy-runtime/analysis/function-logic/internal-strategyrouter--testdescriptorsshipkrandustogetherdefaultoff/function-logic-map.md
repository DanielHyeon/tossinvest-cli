# Function Logic Map: `TestDescriptorsShipKRAndUSTogetherDefaultOFF`

- Source: `internal/strategyrouter/dependency_test.go`
- Qualified function: `TestDescriptorsShipKRAndUSTogetherDefaultOFF`
...
|---|---|---|---|
| function inputs and fixture/runtime state | exact types and identities declared by the source revision | `internal/strategyrouter/dependency_test.go` plus its direct callers/tests | return/error or test assertion; no value is silently repaired |
