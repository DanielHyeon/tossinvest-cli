# Function Logic Map: TestAuthenticatedUnixProjectionCrossNamespaceAndReadOnlyAuthority

- Source: internal/strategyprojectionrpc/transport_unix_test.go
...
|---|---|---|---|
| Function inputs and receiver state | Validated by implementation branches | internal/strategyprojectionrpc/transport_unix_test.go and package-owned authority | Fail closed; no broker authority is synthesized |
