# Function Logic Map: `TestStoreRefusesANewerDerivedSchema`

- Source: `internal/performance/migration_test.go`
- Qualified function: `TestStoreRefusesANewerDerivedSchema`
...
|---|---|---|---|
| function inputs and fixture/runtime state | exact types and identities declared by the source revision | `internal/performance/migration_test.go` plus its direct callers/tests | return/error or test assertion; no value is silently repaired |
