...
|---|---|---|---|
| Function inputs and receiver state | Validated by implementation branches | internal/strategyprojectionrpc/transport_unix.go and package-owned authority | Fail closed; no broker authority is synthesized |
