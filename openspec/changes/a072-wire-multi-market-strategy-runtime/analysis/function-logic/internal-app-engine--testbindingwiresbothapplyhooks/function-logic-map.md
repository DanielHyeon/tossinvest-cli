# Function Logic Map: `TestBindingWiresBothApplyHooks`

- Source: `internal/app/engine/exit_wiring_internal_test.go`
- Qualified function: `TestBindingWiresBothApplyHooks`
...
|---|---|---|---|
| function inputs and fixture/runtime state | exact types and identities declared by the source revision | `internal/app/engine/exit_wiring_internal_test.go` plus its direct callers/tests | return/error or test assertion; no value is silently repaired |
