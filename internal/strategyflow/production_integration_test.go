...
func TestProductionEvaluateUsesRealRouterAndAllSixConcreteEvaluators(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{name: "KR-continuation", market: strategyrouter.MarketKR, horizon: strategyrouter.HorizonShort, laneID: continuationlane.KRContinuationLaneID,
		...
		{name: "US-continuation", market: strategyrouter.MarketUS, horizon: strategyrouter.HorizonShort, laneID: continuationlane.USContinuationLaneID,
		...
		{name: "KR-reversal", market: strategyrouter.MarketKR, horizon: strategyrouter.HorizonShort, laneID: reversallane.KRReversalLaneID,
		...
		{name: "US-reversal", market: strategyrouter.MarketUS, horizon: strategyrouter.HorizonShort, laneID: reversallane.USReversalLaneID,
		...
		{name: "KR-weekly", market: strategyrouter.MarketKR, horizon: strategyrouter.HorizonWeekly, laneID: weeklyvaluelane.KRWeeklyLaneID,
		...
		{name: "US-weekly", market: strategyrouter.MarketUS, horizon: strategyrouter.HorizonWeekly, laneID: weeklyvaluelane.USWeeklyLaneID,
