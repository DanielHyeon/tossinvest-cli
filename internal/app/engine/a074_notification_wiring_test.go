...
// a074 tasks 5 and 7: the transport reaches the Notifier, and a delivered
...
// block. It is separate from writeEngineConfig so a074 adds no field to the
// landed fixture.
