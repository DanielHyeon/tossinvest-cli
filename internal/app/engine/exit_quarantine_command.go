...
// exit_quarantine_command.go is the engine-owned command side of change a063:
...
// claim of a063 is that a release moves one column.
...
// engine that predates a063 must get a screen that says the control plane does
