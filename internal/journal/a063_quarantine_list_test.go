...
// a063 task 3: the list an operator is shown before lifting a quarantine.
//
...
// TestAReleaseDoesNotConsumeTheLedgersAbilityToQuarantineAgain is a063 task 7.2
...
// quarantines on it). Neither is touched by a063, which is the point: a release
...
// TestReleasingAQuarantineWritesNothingButTheQuarantineRow is the a063 spec's
