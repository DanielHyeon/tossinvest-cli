...
// a062 at the record boundary: the transition that quarantined a live position.
//
...
// TestTheFirstRungActivationIsRecordedRatherThanQuarantined is a062 task 3.1.
//
// The shape is the 466100 shape: a canonical snapshot already exists at no rung,
// and the next observation crosses the first take-profit line. Before a062 this
