...
// a062: activating the first ladder rung is a forward move, not an incomparable
// axis.
//
...
// TestFirstRungActivationIsAForwardMove is a062 task 2.1 — the defect itself.
...
// a062 this was refused too, so the spec's "복구된 기준선은 낮아질 수 없다" could
...
// the real ratchet/ladder guard, and a062 leans on it — so it is pinned here
