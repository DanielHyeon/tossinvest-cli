...
// a068: activating the first ladder rung is a forward move, not an incomparable
// axis.
//
...
// TestFirstRungActivationIsAForwardMove is a068 task 2.1 — the defect itself.
...
// a068 this was refused too, so the spec's "복구된 기준선은 낮아질 수 없다" could
...
// the real ratchet/ladder guard, and a068 leans on it — so it is pinned here
