...
// false. A method here would shadow the embedded field at depth 0 — legal, but it
// is the exact shadowing chrome.go warns about, for one value that is already the
// default.
