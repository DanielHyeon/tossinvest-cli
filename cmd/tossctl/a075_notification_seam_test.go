...
// a075_notification_seam_test.go pins the wiring end: what the button actually
...
//
// a074 set the contract — the audit line says whether a channel exists, never
// which one — and a075 is the first change that exercises it several times a
...
//
// The self-hosted path a074 built stays whole: an operator behind a token gets a
